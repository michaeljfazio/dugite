# Nightly Benchmark Results — 2026-08-31

Captured on **2026-08-31** from commit [`14b0617`](https://github.com/MichaelJFazio/dugite/commit/14b0617) on `main` (GitHub Actions `ubuntu-latest`).
...
> The collapsed _Raw measurements_ blocks contain the filtered `cargo bench` output (cargo build chatter and ANSI escapes are stripped). Full unfiltered logs are uploaded as the `benchmark-results-179` workflow artifact.
...
Benchmarking chaindb/sequential_insert/10k_20kb: Collecting 10 samples in estimated 5.0717 s (20 iterations)
Benchmarking chaindb/sequential_insert/10k_20kb: Analyzing
chaindb/sequential_insert/10k_20kb
                        time:   [241.88 ms 242.30 ms 242.68 ms]
                        change: [−8.2349% −6.8475% −5.4106%] (p = 0.00 < 0.05)
...
Benchmarking chaindb/random_read/by_hash/10000blks: Collecting 100 samples in estimated 6.5471 s (20k iterations)
Benchmarking chaindb/random_read/by_hash/10000blks: Analyzing
chaindb/random_read/by_hash/10000blks
                        time:   [323.80 µs 324.01 µs 324.24 µs]
                        change: [+8.3399% +8.6345% +8.9006%] (p = 0.00 < 0.05)
...
Benchmarking chaindb/random_read/by_hash/100000blks: Collecting 100 samples in estimated 5.5764 s (400 iterations)
Benchmarking chaindb/random_read/by_hash/100000blks: Analyzing
chaindb/random_read/by_hash/100000blks
                        time:   [13.895 ms 14.058 ms 14.229 ms]
                        change: [−24.019% −22.513% −21.049%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high mild
...
chaindb/tip_query       time:   [311.64 ps 312.15 ps 312.83 ps]
                        change: [−1.3424% −0.8405% −0.3820%] (p = 0.00 < 0.05)
...
Benchmarking chaindb/has_block: Collecting 100 samples in estimated 5.0954 s (242k iterations)
Benchmarking chaindb/has_block: Analyzing
chaindb/has_block       time:   [22.122 µs 22.457 µs 22.777 µs]
                        change: [−4.2897% −2.5174% −0.6631%] (p = 0.01 < 0.05)
                        Change within noise threshold.

Benchmarking chaindb/slot_range_100
Benchmarking chaindb/slot_range_100: Warming up for 3.0000 s
Benchmarking chaindb/slot_range_100: Collecting 100 samples in estimated 5.0006 s (20M iterations)
Benchmarking chaindb/slot_range_100: Analyzing
chaindb/slot_range_100  time:   [246.33 ns 247.12 ns 247.98 ns]
                        change: [−0.5841% −0.0761% +0.4265%] (p = 0.78 > 0.05)
...
Benchmarking chaindb/flush_to_immutable/k_2160_blocks_20kb/2160: Collecting 10 samples in estimated 5.9654 s (110 iterations)
...
chaindb/flush_to_immutable/k_2160_blocks_20kb/2160
                        time:   [7.6041 ms 7.6444 ms 7.6897 ms]
                        change: [−0.9025% +0.1501% +1.2503%] (p = 0.81 > 0.05)
                        No change in performance detected.
...
Benchmarking chaindb/profile_comparison/insert_10k_20kb/in_memory: Collecting 10 samples in estimated 7.3814 s (30 iterations)
...
chaindb/profile_comparison/insert_10k_20kb/in_memory
                        time:   [245.69 ms 246.38 ms 247.04 ms]
                        change: [−6.6944% −5.6139% −4.6696%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking chaindb/profile_comparison/insert_10k_20kb/mmap: Collecting 10 samples in estimated 7.4260 s (30 iterations)
Benchmarking chaindb/profile_comparison/insert_10k_20kb/mmap: Analyzing
chaindb/profile_comparison/insert_10k_20kb/mmap
                        time:   [247.38 ms 248.10 ms 248.88 ms]
                        change: [−5.5126% −4.8266% −4.0020%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking chaindb/profile_comparison/read_500/in_memory: Collecting 10 samples in estimated 7.4371 s (30 iterations)
Benchmarking chaindb/profile_comparison/read_500/in_memory: Analyzing
chaindb/profile_comparison/read_500/in_memory
                        time:   [33.766 ms 34.156 ms 34.551 ms]
                        change: [−3.2822% −1.6074% +0.1583%] (p = 0.11 > 0.05)
                        No change in performance detected.
...
Benchmarking chaindb/profile_comparison/read_500/mmap: Collecting 10 samples in estimated 7.4836 s (30 iterations)
Benchmarking chaindb/profile_comparison/read_500/mmap: Analyzing
chaindb/profile_comparison/read_500/mmap
                        time:   [34.462 ms 34.783 ms 35.107 ms]
                        change: [−2.3825% −0.9876% +0.4690%] (p = 0.22 > 0.05)
                        No change in performance detected.
...
Benchmarking immutabledb/open/in_memory/10000: Collecting 100 samples in estimated 9.6597 s (100 iterations)
Benchmarking immutabledb/open/in_memory/10000: Analyzing
immutabledb/open/in_memory/10000
                        time:   [96.435 ms 96.730 ms 97.157 ms]
                        change: [−0.9258% −0.5767% −0.0471%] (p = 0.00 < 0.05)
                        Change within noise threshold.
...
Benchmarking immutabledb/open/mmap_cached/10000: Collecting 100 samples in estimated 9.5415 s (100 iterations)
Benchmarking immutabledb/open/mmap_cached/10000: Analyzing
immutabledb/open/mmap_cached/10000
                        time:   [95.660 ms 97.968 ms 102.42 ms]
                        change: [−1.4853% +0.9060% +5.4996%] (p = 0.79 > 0.05)
                        No change in performance detected.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
...
Benchmarking immutabledb/open/mmap_cold_rebuild/10000: Collecting 100 samples in estimated 9.5513 s (100 iterations)
Benchmarking immutabledb/open/mmap_cold_rebuild/10000: Analyzing
immutabledb/open/mmap_cold_rebuild/10000
                        time:   [94.748 ms 95.207 ms 95.879 ms]
                        change: [−3.8892% −2.6224% −1.5949%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Warning: Unable to complete 100 samples in 5.0s. You may wish to increase target time to 100.8s, or reduce sample count to 10.
Benchmarking immutabledb/open/in_memory/100000: Collecting 100 samples in estimated 100.81 s (100 iterations)
Benchmarking immutabledb/open/in_memory/100000: Analyzing
immutabledb/open/in_memory/100000
                        time:   [893.92 ms 904.22 ms 919.21 ms]
                        change: [−2.1760% −0.8667% +0.9175%] (p = 0.33 > 0.05)
                        No change in performance detected.
Found 10 outliers among 100 measurements (10.00%)
  5 (5.00%) high mild
  5 (5.00%) high severe
...
Benchmarking immutabledb/open/mmap_cached/100000: Collecting 100 samples in estimated 89.240 s (100 iterations)
Benchmarking immutabledb/open/mmap_cached/100000: Analyzing
immutabledb/open/mmap_cached/100000
                        time:   [893.63 ms 894.47 ms 895.42 ms]
                        change: [−1.7083% −1.5760% −1.4383%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Warning: Unable to complete 100 samples in 5.0s. You may wish to increase target time to 89.7s, or reduce sample count to 10.
Benchmarking immutabledb/open/mmap_cold_rebuild/100000: Collecting 100 samples in estimated 89.690 s (100 iterations)
Benchmarking immutabledb/open/mmap_cold_rebuild/100000: Analyzing
immutabledb/open/mmap_cold_rebuild/100000
                        time:   [899.13 ms 900.02 ms 901.02 ms]
                        change: [−1.1243% −1.0063% −0.8787%] (p = 0.00 < 0.05)
                        Change within noise threshold.
...
Benchmarking immutabledb/lookup/in_memory/10000: Collecting 100 samples in estimated 5.5558 s (500 iterations)
Benchmarking immutabledb/lookup/in_memory/10000: Analyzing
immutabledb/lookup/in_memory/10000
                        time:   [11.119 ms 11.163 ms 11.209 ms]
                        change: [−6.8541% −6.3700% −5.8464%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 8 outliers among 100 measurements (8.00%)
  8 (8.00%) high mild
Benchmarking immutabledb/lookup/mmap/10000
Benchmarking immutabledb/lookup/mmap/10000: Warming up for 3.0000 s
Benchmarking immutabledb/lookup/mmap/10000: Collecting 100 samples in estimated 5.6571 s (500 iterations)
Benchmarking immutabledb/lookup/mmap/10000: Analyzing
immutabledb/lookup/mmap/10000
                        time:   [11.108 ms 11.143 ms 11.179 ms]
                        change: [−6.5648% −6.1243% −5.6771%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high mild
...
Benchmarking immutabledb/has_block/in_memory: Collecting 100 samples in estimated 5.0431 s (157k iterations)
Benchmarking immutabledb/has_block/in_memory: Analyzing
immutabledb/has_block/in_memory
                        time:   [33.978 µs 34.442 µs 34.887 µs]
                        change: [−6.3565% −3.4384% −0.4988%] (p = 0.03 < 0.05)
                        Change within noise threshold.
Benchmarking immutabledb/has_block/mmap
Benchmarking immutabledb/has_block/mmap: Warming up for 3.0000 s
Benchmarking immutabledb/has_block/mmap: Collecting 100 samples in estimated 5.0534 s (157k iterations)
Benchmarking immutabledb/has_block/mmap: Analyzing
immutabledb/has_block/mmap
                        time:   [34.179 µs 34.643 µs 35.083 µs]
                        change: [−5.9480% −2.9939% −0.0364%] (p = 0.05 > 0.05)
                        No change in performance detected.
...
Benchmarking immutabledb/append/1k_blocks_20kb/in_memory: Collecting 100 samples in estimated 6.5059 s (400 iterations)
Benchmarking immutabledb/append/1k_blocks_20kb/in_memory: Analyzing
immutabledb/append/1k_blocks_20kb/in_memory
                        time:   [16.317 ms 16.380 ms 16.452 ms]
                        change: [−2.4534% −2.0729% −1.5961%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) high mild
  1 (1.00%) high severe
...
Benchmarking immutabledb/append/1k_blocks_20kb/mmap: Collecting 100 samples in estimated 5.0739 s (300 iterations)
Benchmarking immutabledb/append/1k_blocks_20kb/mmap: Analyzing
immutabledb/append/1k_blocks_20kb/mmap
                        time:   [16.719 ms 16.762 ms 16.813 ms]
                        change: [−4.4263% −3.9342% −3.4912%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 5 outliers among 100 measurements (5.00%)
  4 (4.00%) high mild
  1 (1.00%) high severe
...
Benchmarking immutabledb/slot_range/range_100/in_memory: Collecting 100 samples in estimated 6.4851 s (20k iterations)
Benchmarking immutabledb/slot_range/range_100/in_memory: Analyzing
immutabledb/slot_range/range_100/in_memory
                        time:   [318.04 µs 318.97 µs 319.85 µs]
                        change: [−7.4454% −6.8460% −6.2398%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) low mild
...
Benchmarking immutabledb/slot_range/range_100/mmap: Collecting 100 samples in estimated 6.4910 s (20k iterations)
Benchmarking immutabledb/slot_range/range_100/mmap: Analyzing
immutabledb/slot_range/range_100/mmap
                        time:   [322.36 µs 323.12 µs 323.86 µs]
                        change: [−10.641% −9.5284% −8.6549%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 4 outliers among 100 measurements (4.00%)
  4 (4.00%) low mild
...
Benchmarking block_index/insert/in_memory/10000: Collecting 100 samples in estimated 8.0917 s (10k iterations)
Benchmarking block_index/insert/in_memory/10000: Analyzing
block_index/insert/in_memory/10000
                        time:   [795.85 µs 798.63 µs 803.03 µs]
                        change: [−0.7142% −0.3970% −0.0838%] (p = 0.01 < 0.05)
                        Change within noise threshold.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) high mild
  1 (1.00%) high severe
...
Benchmarking block_index/insert/mmap/10000: Collecting 100 samples in estimated 5.4125 s (900 iterations)
Benchmarking block_index/insert/mmap/10000: Analyzing
block_index/insert/mmap/10000
                        time:   [5.9771 ms 5.9975 ms 6.0193 ms]
                        change: [−0.2406% +0.2674% +0.7571%] (p = 0.30 > 0.05)
                        No change in performance detected.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high mild
Benchmarking block_index/insert/in_memory/50000
Benchmarking block_index/insert/in_memory/50000: Warming up for 3.0000 s
Benchmarking block_index/insert/in_memory/50000: Collecting 100 samples in estimated 5.0904 s (1400 iterations)
Benchmarking block_index/insert/in_memory/50000: Analyzing
block_index/insert/in_memory/50000
                        time:   [3.5669 ms 3.5781 ms 3.5891 ms]
                        change: [+1.0567% +1.5437% +1.9900%] (p = 0.00 < 0.05)
                        Performance has regressed.
Benchmarking block_index/insert/mmap/50000
Benchmarking block_index/insert/mmap/50000: Warming up for 3.0000 s
Benchmarking block_index/insert/mmap/50000: Collecting 100 samples in estimated 7.8049 s (200 iterations)
Benchmarking block_index/insert/mmap/50000: Analyzing
block_index/insert/mmap/50000
                        time:   [38.798 ms 39.063 ms 39.375 ms]
                        change: [−2.1012% −1.2653% −0.4167%] (p = 0.00 < 0.05)
                        Change within noise threshold.
...
Benchmarking block_index/insert/in_memory/100000: Collecting 100 samples in estimated 5.2912 s (700 iterations)
Benchmarking block_index/insert/in_memory/100000: Analyzing
block_index/insert/in_memory/100000
                        time:   [7.3851 ms 7.4280 ms 7.4735 ms]
                        change: [−15.906% −14.185% −12.371%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) high mild
  1 (1.00%) high severe
...
Benchmarking block_index/insert/mmap/100000: Collecting 100 samples in estimated 7.6928 s (100 iterations)
Benchmarking block_index/insert/mmap/100000: Analyzing
block_index/insert/mmap/100000
                        time:   [76.880 ms 77.228 ms 77.654 ms]
                        change: [−3.7806% −2.9566% −2.2171%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking block_index/lookup/in_memory/10000: Collecting 100 samples in estimated 5.0698 s (278k iterations)
Benchmarking block_index/lookup/in_memory/10000: Analyzing
block_index/lookup/in_memory/10000
                        time:   [18.291 µs 18.321 µs 18.355 µs]
                        change: [−0.2685% −0.0514% +0.1844%] (p = 0.66 > 0.05)
                        No change in performance detected.
Found 4 outliers among 100 measurements (4.00%)
  3 (3.00%) high mild
  1 (1.00%) high severe
...
Benchmarking block_index/lookup/mmap/10000: Collecting 100 samples in estimated 5.0487 s (197k iterations)
Benchmarking block_index/lookup/mmap/10000: Analyzing
block_index/lookup/mmap/10000
                        time:   [26.668 µs 26.846 µs 27.025 µs]
                        change: [−0.6439% +0.1630% +0.9740%] (p = 0.69 > 0.05)
                        No change in performance detected.
Benchmarking block_index/lookup/in_memory/50000
Benchmarking block_index/lookup/in_memory/50000: Warming up for 3.0000 s
Benchmarking block_index/lookup/in_memory/50000: Collecting 100 samples in estimated 5.0146 s (247k iterations)
Benchmarking block_index/lookup/in_memory/50000: Analyzing
block_index/lookup/in_memory/50000
                        time:   [20.290 µs 20.309 µs 20.329 µs]
                        change: [+6.3168% +7.7245% +8.9429%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 7 outliers among 100 measurements (7.00%)
  2 (2.00%) high mild
  5 (5.00%) high severe
...
Benchmarking block_index/lookup/mmap/50000: Collecting 100 samples in estimated 5.0152 s (258k iterations)
Benchmarking block_index/lookup/mmap/50000: Analyzing
block_index/lookup/mmap/50000
                        time:   [20.202 µs 20.294 µs 20.378 µs]
                        change: [−0.4860% +0.0644% +0.6518%] (p = 0.83 > 0.05)
                        No change in performance detected.
...
Benchmarking block_index/lookup/in_memory/100000: Collecting 100 samples in estimated 5.0490 s (268k iterations)
Benchmarking block_index/lookup/in_memory/100000: Analyzing
block_index/lookup/in_memory/100000
                        time:   [18.877 µs 18.901 µs 18.926 µs]
                        change: [−0.2025% +0.3013% +0.7613%] (p = 0.25 > 0.05)
                        No change in performance detected.
Found 4 outliers among 100 measurements (4.00%)
  2 (2.00%) high mild
  2 (2.00%) high severe
...
Benchmarking block_index/lookup/mmap/100000: Collecting 100 samples in estimated 5.0059 s (263k iterations)
Benchmarking block_index/lookup/mmap/100000: Analyzing
block_index/lookup/mmap/100000
                        time:   [19.759 µs 19.851 µs 19.937 µs]
                        change: [−0.3905% +0.2062% +0.8155%] (p = 0.49 > 0.05)
                        No change in performance detected.
...
Benchmarking block_index/contains_miss/in_memory: Collecting 100 samples in estimated 5.0261 s (414k iterations)
Benchmarking block_index/contains_miss/in_memory: Analyzing
block_index/contains_miss/in_memory
                        time:   [12.141 µs 12.158 µs 12.178 µs]
                        change: [+0.1771% +0.5614% +0.8713%] (p = 0.00 < 0.05)
                        Change within noise threshold.
...
Benchmarking block_index/contains_miss/mmap: Collecting 100 samples in estimated 5.1343 s (116k iterations)
Benchmarking block_index/contains_miss/mmap: Analyzing
block_index/contains_miss/mmap
                        time:   [40.681 µs 41.301 µs 41.949 µs]
                        change: [−1.5769% +0.0409% +1.6442%] (p = 0.96 > 0.05)
                        No change in performance detected.
...
Benchmarking scaling/block_index_insert/in_memory/10000: Collecting 10 samples in estimated 5.0001 s (6325 iterations)
Benchmarking scaling/block_index_insert/in_memory/10000: Analyzing
scaling/block_index_insert/in_memory/10000
                        time:   [790.78 µs 791.98 µs 793.27 µs]
                        change: [−0.7616% −0.4122% −0.0630%] (p = 0.04 < 0.05)
                        Change within noise threshold.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
Benchmarking scaling/block_index_insert/mmap/10000: Collecting 10 samples in estimated 5.0882 s (825 iterations)
Benchmarking scaling/block_index_insert/mmap/10000: Analyzing
scaling/block_index_insert/mmap/10000
                        time:   [6.0512 ms 6.1029 ms 6.1738 ms]
                        change: [+0.4789% +1.2640% +2.0537%] (p = 0.01 < 0.05)
                        Change within noise threshold.
...
Benchmarking scaling/block_index_insert/in_memory/50000: Collecting 10 samples in estimated 5.0557 s (1430 iterations)
Benchmarking scaling/block_index_insert/in_memory/50000: Analyzing
scaling/block_index_insert/in_memory/50000
                        time:   [3.5279 ms 3.5311 ms 3.5366 ms]
                        change: [−0.3110% +1.5362% +3.1397%] (p = 0.12 > 0.05)
                        No change in performance detected.
...
Benchmarking scaling/block_index_insert/mmap/50000: Collecting 10 samples in estimated 6.4521 s (165 iterations)
Benchmarking scaling/block_index_insert/mmap/50000: Analyzing
scaling/block_index_insert/mmap/50000
                        time:   [39.123 ms 39.223 ms 39.354 ms]
                        change: [−0.3766% −0.0806% +0.2617%] (p = 0.65 > 0.05)
                        No change in performance detected.
Found 2 outliers among 10 measurements (20.00%)
  2 (20.00%) high mild
...
Benchmarking scaling/block_index_insert/in_memory/100000: Collecting 10 samples in estimated 5.2754 s (715 iterations)
Benchmarking scaling/block_index_insert/in_memory/100000: Analyzing
scaling/block_index_insert/in_memory/100000
                        time:   [7.3054 ms 7.4969 ms 7.7387 ms]
                        change: [−14.856% −10.401% −6.3307%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 10 measurements (20.00%)
  2 (20.00%) high severe
...
Benchmarking scaling/block_index_insert/mmap/100000: Collecting 10 samples in estimated 8.5438 s (110 iterations)
Benchmarking scaling/block_index_insert/mmap/100000: Analyzing
scaling/block_index_insert/mmap/100000
                        time:   [77.576 ms 77.815 ms 78.001 ms]
                        change: [−2.3893% −2.0193% −1.6694%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking scaling/block_index_lookup/in_memory/10000: Collecting 10 samples in estimated 5.0001 s (269k iterations)
Benchmarking scaling/block_index_lookup/in_memory/10000: Analyzing
scaling/block_index_lookup/in_memory/10000
                        time:   [18.342 µs 18.359 µs 18.383 µs]
                        change: [+0.1390% +0.4266% +0.7255%] (p = 0.01 < 0.05)
                        Change within noise threshold.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
Benchmarking scaling/block_index_lookup/mmap/10000: Collecting 10 samples in estimated 5.0002 s (180k iterations)
Benchmarking scaling/block_index_lookup/mmap/10000: Analyzing
scaling/block_index_lookup/mmap/10000
                        time:   [25.640 µs 25.672 µs 25.722 µs]
                        change: [−2.2825% −0.0801% +1.7935%] (p = 0.91 > 0.05)
                        No change in performance detected.
Found 2 outliers among 10 measurements (20.00%)
  1 (10.00%) high mild
  1 (10.00%) high severe
...
Benchmarking scaling/block_index_lookup/in_memory/50000: Collecting 10 samples in estimated 5.0001 s (264k iterations)
Benchmarking scaling/block_index_lookup/in_memory/50000: Analyzing
scaling/block_index_lookup/in_memory/50000
                        time:   [18.772 µs 18.797 µs 18.833 µs]
                        change: [+0.2287% +0.5930% +0.9920%] (p = 0.01 < 0.05)
                        Change within noise threshold.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
scaling/block_index_lookup/mmap/50000
                        time:   [19.445 µs 19.455 µs 19.472 µs]
                        change: [−1.8780% +0.0308% +1.9692%] (p = 0.88 > 0.05)
                        No change in performance detected.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
Benchmarking scaling/block_index_lookup/in_memory/100000: Collecting 10 samples in estimated 5.0001 s (263k iterations)
Benchmarking scaling/block_index_lookup/in_memory/100000: Analyzing
scaling/block_index_lookup/in_memory/100000
                        time:   [18.808 µs 18.818 µs 18.830 µs]
                        change: [+0.0742% +0.2561% +0.4215%] (p = 0.01 < 0.05)
                        Change within noise threshold.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
scaling/block_index_lookup/mmap/100000
                        time:   [19.010 µs 19.038 µs 19.066 µs]
                        change: [−1.8505% +0.0722% +2.1179%] (p = 0.84 > 0.05)
                        No change in performance detected.
Found 2 outliers among 10 measurements (20.00%)
  1 (10.00%) high mild
  1 (10.00%) high severe
...
Benchmarking scaling/immutabledb_open/in_memory/10000: Collecting 10 samples in estimated 5.3308 s (55 iterations)
Benchmarking scaling/immutabledb_open/in_memory/10000: Analyzing
scaling/immutabledb_open/in_memory/10000
                        time:   [96.381 ms 97.040 ms 98.125 ms]
                        change: [−2.0687% −1.5206% −0.7534%] (p = 0.00 < 0.05)
                        Change within noise threshold.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
Warning: Unable to complete 10 samples in 5.0s. You may wish to increase target time to 5.3s or enable flat sampling.
Benchmarking scaling/immutabledb_open/mmap_cached/10000: Collecting 10 samples in estimated 5.2823 s (55 iterations)
Benchmarking scaling/immutabledb_open/mmap_cached/10000: Analyzing
scaling/immutabledb_open/mmap_cached/10000
                        time:   [95.489 ms 96.009 ms 97.034 ms]
                        change: [−2.4694% −1.6113% −0.7861%] (p = 0.00 < 0.05)
                        Change within noise threshold.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
Benchmarking scaling/immutabledb_open/in_memory/50000: Collecting 10 samples in estimated 9.0867 s (20 iterations)
Benchmarking scaling/immutabledb_open/in_memory/50000: Analyzing
scaling/immutabledb_open/in_memory/50000
                        time:   [449.61 ms 450.47 ms 451.22 ms]
                        change: [−1.6388% −1.3661% −1.1104%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) low mild
...
Benchmarking scaling/immutabledb_open/mmap_cached/50000: Collecting 10 samples in estimated 9.0101 s (20 iterations)
Benchmarking scaling/immutabledb_open/mmap_cached/50000: Analyzing
scaling/immutabledb_open/mmap_cached/50000
                        time:   [448.87 ms 450.20 ms 451.52 ms]
                        change: [−1.7522% −1.2681% −0.8384%] (p = 0.00 < 0.05)
                        Change within noise threshold.
...
Benchmarking scaling/immutabledb_open/in_memory/100000: Collecting 10 samples in estimated 11.257 s (10 iterations)
Benchmarking scaling/immutabledb_open/in_memory/100000: Analyzing
scaling/immutabledb_open/in_memory/100000
                        time:   [890.91 ms 891.94 ms 892.96 ms]
                        change: [−1.7247% −1.5286% −1.3472%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking scaling/immutabledb_open/mmap_cached/100000: Collecting 10 samples in estimated 8.9173 s (10 iterations)
Benchmarking scaling/immutabledb_open/mmap_cached/100000: Analyzing
scaling/immutabledb_open/mmap_cached/100000
                        time:   [890.41 ms 892.94 ms 895.56 ms]
                        change: [−1.7231% −1.4482% −1.1588%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking scaling/chaindb_insert/default_20kb/10000: Collecting 10 samples in estimated 7.3159 s (30 iterations)
Benchmarking scaling/chaindb_insert/default_20kb/10000: Analyzing
scaling/chaindb_insert/default_20kb/10000
                        time:   [242.48 ms 243.25 ms 244.09 ms]
                        change: [−5.6423% −4.7547% −3.7656%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking utxo_store/insert/default/1000000: Collecting 10 samples in estimated 31.918 s (10 iterations)
Benchmarking utxo_store/insert/default/1000000: Analyzing
utxo_store/insert/default/1000000
                        time:   [3.0939 s 3.1180 s 3.1445 s]
                        change: [+15.159% +16.431% +17.799%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
Benchmarking utxo_store/lookup/hit/1000000: Collecting 100 samples in estimated 6.3762 s (15k iterations)
Benchmarking utxo_store/lookup/hit/1000000: Analyzing
utxo_store/lookup/hit/1000000
                        time:   [416.51 µs 417.46 µs 418.84 µs]
                        change: [−25.831% −25.522% −25.146%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 7 outliers among 100 measurements (7.00%)
  4 (4.00%) high mild
  3 (3.00%) high severe
...
Benchmarking utxo_store/lookup/miss/1000000: Collecting 100 samples in estimated 5.4816 s (25k iterations)
Benchmarking utxo_store/lookup/miss/1000000: Analyzing
utxo_store/lookup/miss/1000000
                        time:   [217.45 µs 217.69 µs 217.98 µs]
                        change: [−35.558% −35.370% −35.164%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking utxo_store/contains/hit: Collecting 100 samples in estimated 6.3609 s (20k iterations)
Benchmarking utxo_store/contains/hit: Analyzing
utxo_store/contains/hit time:   [312.90 µs 313.23 µs 313.61 µs]
                        change: [−30.307% −29.907% −29.145%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 10 outliers among 100 measurements (10.00%)
  2 (2.00%) low mild
  5 (5.00%) high mild
...
Benchmarking utxo_store/contains/miss: Collecting 100 samples in estimated 5.4952 s (25k iterations)
Benchmarking utxo_store/contains/miss: Analyzing
utxo_store/contains/miss
                        time:   [216.90 µs 217.13 µs 217.42 µs]
                        change: [−31.949% −31.630% −31.227%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 7 outliers among 100 measurements (7.00%)
  3 (3.00%) high mild
  4 (4.00%) high severe
...
Benchmarking utxo_store/remove/sequential/1000000: Collecting 10 samples in estimated 59.113 s (10 iterations)
Benchmarking utxo_store/remove/sequential/1000000: Analyzing
utxo_store/remove/sequential/1000000
                        time:   [3.1349 s 3.1447 s 3.1559 s]
                        change: [+13.728% +14.317% +14.888%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 10 measurements (20.00%)
  2 (20.00%) high mild
...
Benchmarking utxo_store/apply_tx/block_50tx_3in_2out: Collecting 10 samples in estimated 32.434 s (10 iterations)
Benchmarking utxo_store/apply_tx/block_50tx_3in_2out: Analyzing
utxo_store/apply_tx/block_50tx_3in_2out
                        time:   [384.39 ms 393.02 ms 403.12 ms]
                        change: [+33.841% +40.517% +48.106%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
Benchmarking utxo_store/apply_tx/block_300tx_2in_2out: Collecting 10 samples in estimated 31.562 s (10 iterations)
Benchmarking utxo_store/apply_tx/block_300tx_2in_2out: Analyzing
utxo_store/apply_tx/block_300tx_2in_2out
                        time:   [382.92 ms 392.95 ms 403.20 ms]
                        change: [+35.664% +41.123% +46.639%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_store/multi_asset/insert_mixed_30pct/1000000: Collecting 10 samples in estimated 39.883 s (10 iterations)
...
utxo_store/multi_asset/insert_mixed_30pct/1000000
                        time:   [3.8238 s 3.8402 s 3.8602 s]
                        change: [+10.268% +10.956% +11.700%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 10 measurements (20.00%)
  1 (10.00%) low mild
  1 (10.00%) high severe
...
Benchmarking utxo_store/multi_asset/lookup_mixed_30pct/1000000: Collecting 10 samples in estimated 38.912 s (10 iterations)
...
utxo_store/multi_asset/lookup_mixed_30pct/1000000
                        time:   [138.95 ms 152.35 ms 165.14 ms]
                        change: [+11.024% +24.984% +40.222%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_store/total_lovelace/scan/1000000: Collecting 100 samples in estimated 27.177 s (100 iterations)
Benchmarking utxo_store/total_lovelace/scan/1000000: Analyzing
utxo_store/total_lovelace/scan/1000000
                        time:   [267.74 ms 269.32 ms 271.31 ms]
                        change: [−1.9518% −1.3963% −0.6110%] (p = 0.00 < 0.05)
                        Change within noise threshold.
Found 6 outliers among 100 measurements (6.00%)
  6 (6.00%) high severe
...
Benchmarking utxo_store/rebuild_address_index/rebuild/1000000: Collecting 10 samples in estimated 40.821 s (10 iterations)
Benchmarking utxo_store/rebuild_address_index/rebuild/1000000: Analyzing
utxo_store/rebuild_address_index/rebuild/1000000
                        time:   [493.47 ms 496.38 ms 500.64 ms]
                        change: [+2.6232% +3.4776% +4.5309%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 10 measurements (20.00%)
  1 (10.00%) high mild
  1 (10.00%) high severe
...
Benchmarking utxo_store/insert_configs/low_8gb/1000000: Collecting 10 samples in estimated 30.987 s (10 iterations)
Benchmarking utxo_store/insert_configs/low_8gb/1000000: Analyzing
utxo_store/insert_configs/low_8gb/1000000
                        time:   [3.1162 s 3.1441 s 3.1789 s]
                        change: [+18.678% +19.857% +21.194%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
Benchmarking utxo_store/insert_configs/mid_16gb/1000000: Collecting 10 samples in estimated 31.827 s (10 iterations)
Benchmarking utxo_store/insert_configs/mid_16gb/1000000: Analyzing
utxo_store/insert_configs/mid_16gb/1000000
                        time:   [3.1358 s 3.1526 s 3.1716 s]
                        change: [+18.749% +19.538% +20.400%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 10 measurements (20.00%)
  1 (10.00%) low mild
  1 (10.00%) high severe
...
Benchmarking utxo_store/insert_configs/high_32gb/1000000: Collecting 10 samples in estimated 31.415 s (10 iterations)
Benchmarking utxo_store/insert_configs/high_32gb/1000000: Analyzing
utxo_store/insert_configs/high_32gb/1000000
                        time:   [3.1100 s 3.1291 s 3.1492 s]
                        change: [+18.132% +19.026% +19.935%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_store/insert_configs/high_bloom_16gb/1000000: Collecting 10 samples in estimated 31.273 s (10 iterations)
...
utxo_store/insert_configs/high_bloom_16gb/1000000
                        time:   [3.1557 s 3.1886 s 3.2251 s]
                        change: [+19.376% +20.843% +22.349%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Warning: Unable to complete 10 samples in 5.0s. You may wish to increase target time to 32.4s.
Benchmarking utxo_store/insert_configs/legacy_small/1000000: Collecting 10 samples in estimated 32.439 s (10 iterations)
Benchmarking utxo_store/insert_configs/legacy_small/1000000: Analyzing
utxo_store/insert_configs/legacy_small/1000000
                        time:   [3.1373 s 3.1586 s 3.1805 s]
                        change: [+18.878% +19.727% +20.546%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_store/lookup_configs/low_8gb/1000000: Collecting 100 samples in estimated 5.1933 s (15k iterations)
Benchmarking utxo_store/lookup_configs/low_8gb/1000000: Analyzing
utxo_store/lookup_configs/low_8gb/1000000
                        time:   [336.47 µs 337.70 µs 339.25 µs]
                        change: [−23.908% −23.506% −23.076%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 9 outliers among 100 measurements (9.00%)
  2 (2.00%) high mild
  7 (7.00%) high severe
...
Benchmarking utxo_store/lookup_configs/mid_16gb/1000000: Collecting 100 samples in estimated 5.2049 s (15k iterations)
Benchmarking utxo_store/lookup_configs/mid_16gb/1000000: Analyzing
utxo_store/lookup_configs/mid_16gb/1000000
                        time:   [337.90 µs 338.60 µs 339.49 µs]
                        change: [−22.745% −22.435% −22.043%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 4 outliers among 100 measurements (4.00%)
  2 (2.00%) high mild
  2 (2.00%) high severe
...
Benchmarking utxo_store/lookup_configs/high_32gb/1000000: Collecting 100 samples in estimated 5.1696 s (15k iterations)
Benchmarking utxo_store/lookup_configs/high_32gb/1000000: Analyzing
utxo_store/lookup_configs/high_32gb/1000000
                        time:   [332.74 µs 333.12 µs 333.56 µs]
                        change: [−24.957% −24.532% −24.035%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 4 outliers among 100 measurements (4.00%)
  1 (1.00%) high mild
  3 (3.00%) high severe
...
Benchmarking utxo_store/lookup_configs/high_bloom_16gb/1000000: Collecting 100 samples in estimated 5.1600 s (15k iterations)
...
utxo_store/lookup_configs/high_bloom_16gb/1000000
                        time:   [334.60 µs 335.21 µs 336.00 µs]
                        change: [−24.294% −23.832% −23.307%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 10 outliers among 100 measurements (10.00%)
  6 (6.00%) high mild
  4 (4.00%) high severe
...
Benchmarking utxo_store/lookup_configs/legacy_small/1000000: Collecting 100 samples in estimated 5.1171 s (15k iterations)
Benchmarking utxo_store/lookup_configs/legacy_small/1000000: Analyzing
utxo_store/lookup_configs/legacy_small/1000000
                        time:   [339.35 µs 340.07 µs 340.91 µs]
                        change: [−23.411% −23.110% −22.817%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 5 outliers among 100 measurements (5.00%)
  3 (3.00%) high mild
  2 (2.00%) high severe
...
Benchmarking utxo_scaling/insert/default/100000: Collecting 10 samples in estimated 7.3358 s (30 iterations)
Benchmarking utxo_scaling/insert/default/100000: Analyzing
utxo_scaling/insert/default/100000
                        time:   [245.74 ms 247.44 ms 249.11 ms]
                        change: [+12.706% +13.671% +14.638%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_scaling/insert/default/500000: Collecting 10 samples in estimated 14.524 s (10 iterations)
Benchmarking utxo_scaling/insert/default/500000: Analyzing
utxo_scaling/insert/default/500000
                        time:   [1.4481 s 1.4599 s 1.4746 s]
                        change: [+16.122% +17.839% +19.693%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
Benchmarking utxo_scaling/insert/default/1000000: Collecting 10 samples in estimated 31.509 s (10 iterations)
Benchmarking utxo_scaling/insert/default/1000000: Analyzing
utxo_scaling/insert/default/1000000
                        time:   [3.1795 s 3.2054 s 3.2401 s]
                        change: [+20.641% +21.727% +23.199%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
Benchmarking utxo_scaling/lookup/hit/100000: Collecting 10 samples in estimated 5.0106 s (19k iterations)
Benchmarking utxo_scaling/lookup/hit/100000: Analyzing
utxo_scaling/lookup/hit/100000
                        time:   [267.50 µs 267.85 µs 268.50 µs]
                        change: [−25.886% −25.417% −24.845%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
Benchmarking utxo_scaling/lookup/hit/500000
Benchmarking utxo_scaling/lookup/hit/500000: Warming up for 3.0000 s
Benchmarking utxo_scaling/lookup/hit/500000: Collecting 10 samples in estimated 5.0154 s (15k iterations)
Benchmarking utxo_scaling/lookup/hit/500000: Analyzing
utxo_scaling/lookup/hit/500000
                        time:   [314.86 µs 316.72 µs 319.96 µs]
                        change: [−23.183% −21.463% −19.651%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 10 measurements (20.00%)
  2 (20.00%) high severe
Benchmarking utxo_scaling/lookup/hit/1000000
Benchmarking utxo_scaling/lookup/hit/1000000: Warming up for 3.0000 s
Benchmarking utxo_scaling/lookup/hit/1000000: Collecting 10 samples in estimated 5.0176 s (15k iterations)
Benchmarking utxo_scaling/lookup/hit/1000000: Analyzing
utxo_scaling/lookup/hit/1000000
                        time:   [328.96 µs 332.79 µs 335.68 µs]
                        change: [−24.025% −23.532% −23.171%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) low severe
...
Benchmarking utxo_scaling/apply_tx/block_50tx_3in_2out/100000: Collecting 10 samples in estimated 7.4477 s (30 iterations)
Benchmarking utxo_scaling/apply_tx/block_50tx_3in_2out/100000: Analyzing
utxo_scaling/apply_tx/block_50tx_3in_2out/100000
                        time:   [18.557 ms 20.095 ms 21.864 ms]
                        change: [+48.923% +63.271% +79.118%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_scaling/apply_tx/block_50tx_3in_2out/500000: Collecting 10 samples in estimated 14.842 s (10 iterations)
Benchmarking utxo_scaling/apply_tx/block_50tx_3in_2out/500000: Analyzing
utxo_scaling/apply_tx/block_50tx_3in_2out/500000
                        time:   [168.72 ms 177.18 ms 184.91 ms]
                        change: [+30.466% +38.778% +46.903%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Warning: Unable to complete 10 samples in 5.0s. You may wish to increase target time to 31.6s.
Benchmarking utxo_scaling/apply_tx/block_50tx_3in_2out/1000000: Collecting 10 samples in estimated 31.567 s (10 iterations)
...
utxo_scaling/apply_tx/block_50tx_3in_2out/1000000
                        time:   [400.19 ms 414.45 ms 431.67 ms]
                        change: [+46.246% +52.553% +59.675%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
Benchmarking utxo_scaling/total_lovelace/scan/100000: Collecting 10 samples in estimated 6.1721 s (220 iterations)
Benchmarking utxo_scaling/total_lovelace/scan/100000: Analyzing
utxo_scaling/total_lovelace/scan/100000
                        time:   [26.318 ms 27.387 ms 28.246 ms]
                        change: [+11.821% +15.447% +18.621%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_scaling/total_lovelace/scan/500000: Collecting 10 samples in estimated 7.3017 s (55 iterations)
Benchmarking utxo_scaling/total_lovelace/scan/500000: Analyzing
utxo_scaling/total_lovelace/scan/500000
                        time:   [132.37 ms 133.05 ms 134.25 ms]
                        change: [−2.4918% −1.8106% −0.8001%] (p = 0.00 < 0.05)
                        Change within noise threshold.
Found 3 outliers among 10 measurements (30.00%)
  1 (10.00%) low severe
  2 (20.00%) high severe
...
Benchmarking utxo_scaling/total_lovelace/scan/1000000: Collecting 10 samples in estimated 5.9510 s (20 iterations)
Benchmarking utxo_scaling/total_lovelace/scan/1000000: Analyzing
utxo_scaling/total_lovelace/scan/1000000
                        time:   [277.04 ms 278.94 ms 280.68 ms]
                        change: [+3.0895% +3.7654% +4.4520%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) low mild
...
Warning: Unable to complete 10 samples in 5.0s. You may wish to increase target time to 189.6s.
Benchmarking utxo_large_scale/insert/default/5000000: Collecting 10 samples in estimated 189.64 s (10 iterations)
Benchmarking utxo_large_scale/insert/default/5000000: Analyzing
utxo_large_scale/insert/default/5000000
                        time:   [18.521 s 18.632 s 18.750 s]
                        change: [+17.660% +18.378% +19.120%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Warning: Unable to complete 10 samples in 5.0s. You may wish to increase target time to 402.9s.
Benchmarking utxo_large_scale/insert/default/10000000: Collecting 10 samples in estimated 402.87 s (10 iterations)
Benchmarking utxo_large_scale/insert/default/10000000: Analyzing
utxo_large_scale/insert/default/10000000
                        time:   [39.087 s 39.238 s 39.402 s]
                        change: [+16.219% +16.740% +17.312%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
Benchmarking utxo_large_scale/lookup/hit/5000000: Collecting 10 samples in estimated 5.0651 s (3795 iterations)
Benchmarking utxo_large_scale/lookup/hit/5000000: Analyzing
utxo_large_scale/lookup/hit/5000000
                        time:   [1.3220 ms 1.3352 ms 1.3449 ms]
                        change: [+2.0764% +2.8110% +3.6035%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_large_scale/lookup/hit/10000000: Collecting 10 samples in estimated 5.0624 s (2860 iterations)
Benchmarking utxo_large_scale/lookup/hit/10000000: Analyzing
utxo_large_scale/lookup/hit/10000000
                        time:   [1.7275 ms 1.7312 ms 1.7352 ms]
                        change: [+10.330% +10.780% +11.234%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_large_scale/total_lovelace/scan/5000000: Collecting 10 samples in estimated 15.603 s (10 iterations)
Benchmarking utxo_large_scale/total_lovelace/scan/5000000: Analyzing
utxo_large_scale/total_lovelace/scan/5000000
                        time:   [1.5678 s 1.5751 s 1.5836 s]
                        change: [+1.4476% +1.9388% +2.5179%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_large_scale/total_lovelace/scan/10000000: Collecting 10 samples in estimated 30.722 s (10 iterations)
Benchmarking utxo_large_scale/total_lovelace/scan/10000000: Analyzing
utxo_large_scale/total_lovelace/scan/10000000
                        time:   [3.0872 s 3.1031 s 3.1241 s]
                        change: [−1.4380% −0.3956% +0.6789%] (p = 0.49 > 0.05)
                        No change in performance detected.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
Benchmarking ledger/apply_block/apply_only_shelley_50tx: Collecting 20 samples in estimated 5.0028 s (64k iterations)
Benchmarking ledger/apply_block/apply_only_shelley_50tx: Analyzing
ledger/apply_block/apply_only_shelley_50tx
                        time:   [76.417 µs 76.474 µs 76.574 µs]
                        change: [+7.1647% +7.7368% +8.1790%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking ledger/apply_block/validate_all_shelley_50tx: Collecting 20 samples in estimated 5.0018 s (36k iterations)
Benchmarking ledger/apply_block/validate_all_shelley_50tx: Analyzing
ledger/apply_block/validate_all_shelley_50tx
                        time:   [138.09 µs 138.22 µs 138.33 µs]
                        change: [+1.6762% +1.9214% +2.2121%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
network/handshake_encode/n2n_version_data
                        time:   [43.607 ns 43.784 ns 44.043 ns]
                        change: [+23.194% +24.130% +25.296%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  6 (6.00%) high severe
...
network/handshake_encode/n2c_version_data
                        time:   [24.063 ns 24.168 ns 24.304 ns]
                        change: [+6.0145% +6.6160% +7.2495%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  3 (3.00%) high mild
  3 (3.00%) high severe
...
network/chainsync/roll_forward/encode/256
                        time:   [115.96 ns 116.04 ns 116.12 ns]
                        thrpt:  [2.4942 GiB/s 2.4961 GiB/s 2.4977 GiB/s]
                 change:
                        time:   [+29.057% +29.348% +29.661%] (p = 0.00 < 0.05)
                        thrpt:  [−22.876% −22.689% −22.515%]
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) high mild
  1 (1.00%) high severe
...
network/chainsync/roll_forward/decode/256
                        time:   [99.118 ns 100.18 ns 101.43 ns]
                        thrpt:  [2.8555 GiB/s 2.8912 GiB/s 2.9222 GiB/s]
                 change:
                        time:   [+8.2634% +8.7584% +9.3368%] (p = 0.00 < 0.05)
                        thrpt:  [−8.5395% −8.0530% −7.6327%]
                        Performance has regressed.
Found 7 outliers among 100 measurements (7.00%)
  4 (4.00%) high mild
  3 (3.00%) high severe
...
Benchmarking network/chainsync/roll_forward/encode/1024: Collecting 100 samples in estimated 5.0006 s (31M iterations)
Benchmarking network/chainsync/roll_forward/encode/1024: Analyzing
network/chainsync/roll_forward/encode/1024
                        time:   [162.50 ns 162.75 ns 162.99 ns]
                        thrpt:  [6.1653 GiB/s 6.1745 GiB/s 6.1841 GiB/s]
                 change:
                        time:   [+39.174% +39.580% +40.052%] (p = 0.00 < 0.05)
                        thrpt:  [−28.598% −28.356% −28.147%]
                        Performance has regressed.
Found 8 outliers among 100 measurements (8.00%)
  6 (6.00%) high mild
  2 (2.00%) high severe
...
network/chainsync/roll_forward/decode/1024
                        time:   [110.39 ns 111.76 ns 113.29 ns]
                        thrpt:  [8.8700 GiB/s 8.9914 GiB/s 9.1034 GiB/s]
                 change:
                        time:   [+15.442% +16.970% +18.740%] (p = 0.00 < 0.05)
                        thrpt:  [−15.782% −14.508% −13.376%]
                        Performance has regressed.
Found 8 outliers among 100 measurements (8.00%)
  1 (1.00%) high mild
  7 (7.00%) high severe
...
network/chainsync/roll_forward/encode/4096
                        time:   [280.40 ns 280.56 ns 280.72 ns]
                        thrpt:  [13.771 GiB/s 13.779 GiB/s 13.787 GiB/s]
                 change:
                        time:   [+86.385% +87.170% +87.895%] (p = 0.00 < 0.05)
                        thrpt:  [−46.779% −46.573% −46.348%]
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  3 (3.00%) high mild
  3 (3.00%) high severe
...
Benchmarking network/chainsync/roll_forward/decode/4096: Collecting 100 samples in estimated 5.0001 s (25M iterations)
Benchmarking network/chainsync/roll_forward/decode/4096: Analyzing
network/chainsync/roll_forward/decode/4096
                        time:   [194.11 ns 195.33 ns 196.78 ns]
                        thrpt:  [19.646 GiB/s 19.792 GiB/s 19.916 GiB/s]
                 change:
                        time:   [+31.170% +31.807% +32.361%] (p = 0.00 < 0.05)
                        thrpt:  [−24.449% −24.132% −23.763%]
                        Performance has regressed.
Found 4 outliers among 100 measurements (4.00%)
  4 (4.00%) high severe
...
network/chainsync/roll_backward/encode
                        time:   [165.61 ns 166.49 ns 167.49 ns]
                        thrpt:  [501.08 MiB/s 504.08 MiB/s 506.76 MiB/s]
                 change:
                        time:   [+19.628% +20.158% +20.609%] (p = 0.00 < 0.05)
                        thrpt:  [−17.087% −16.776% −16.408%]
                        Performance has regressed.
...
network/chainsync/roll_backward/decode
                        time:   [71.816 ns 72.089 ns 72.352 ns]
                        thrpt:  [1.1328 GiB/s 1.1369 GiB/s 1.1412 GiB/s]
                 change:
                        time:   [+30.213% +30.824% +31.403%] (p = 0.00 < 0.05)
                        thrpt:  [−23.898% −23.561% −23.203%]
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high mild
...
network/blockfetch/msg_block/encode/2048
                        time:   [108.27 ns 108.78 ns 109.42 ns]
                        thrpt:  [17.475 GiB/s 17.577 GiB/s 17.659 GiB/s]
                 change:
                        time:   [+21.036% +21.850% +23.193%] (p = 0.00 < 0.05)
                        thrpt:  [−18.826% −17.932% −17.380%]
                        Performance has regressed.
Found 5 outliers among 100 measurements (5.00%)
  5 (5.00%) high severe
...
Benchmarking network/blockfetch/msg_block/decode/2048: Collecting 100 samples in estimated 5.0002 s (69M iterations)
Benchmarking network/blockfetch/msg_block/decode/2048: Analyzing
network/blockfetch/msg_block/decode/2048
                        time:   [72.924 ns 73.464 ns 74.177 ns]
                        thrpt:  [25.776 GiB/s 26.027 GiB/s 26.219 GiB/s]
                 change:
                        time:   [−11.223% −10.820% −10.352%] (p = 0.00 < 0.05)
                        thrpt:  [+11.547% +12.133% +12.642%]
                        Performance has improved.
Found 3 outliers among 100 measurements (3.00%)
  1 (1.00%) high mild
  2 (2.00%) high severe
...
Benchmarking network/blockfetch/msg_block/encode/20480: Collecting 100 samples in estimated 5.0004 s (9.6M iterations)
Benchmarking network/blockfetch/msg_block/encode/20480: Analyzing
network/blockfetch/msg_block/encode/20480
                        time:   [520.96 ns 521.36 ns 521.84 ns]
                        thrpt:  [36.559 GiB/s 36.593 GiB/s 36.621 GiB/s]
                 change:
                        time:   [+10.097% +10.298% +10.566%] (p = 0.00 < 0.05)
                        thrpt:  [−9.5561% −9.3368% −9.1708%]
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  4 (4.00%) high mild
  2 (2.00%) high severe
...
Benchmarking network/blockfetch/msg_block/decode/20480: Collecting 100 samples in estimated 5.0245 s (727k iterations)
Benchmarking network/blockfetch/msg_block/decode/20480: Analyzing
network/blockfetch/msg_block/decode/20480
                        time:   [6.8543 µs 6.8917 µs 6.9486 µs]
                        thrpt:  [2.7456 GiB/s 2.7683 GiB/s 2.7834 GiB/s]
                 change:
                        time:   [+15.029% +15.779% +16.685%] (p = 0.00 < 0.05)
                        thrpt:  [−14.299% −13.628% −13.065%]
                        Performance has regressed.
...
Benchmarking network/blockfetch/msg_block/encode/90000: Collecting 100 samples in estimated 5.0095 s (2.4M iterations)
Benchmarking network/blockfetch/msg_block/encode/90000: Analyzing
network/blockfetch/msg_block/encode/90000
                        time:   [2.0627 µs 2.0638 µs 2.0653 µs]
                        thrpt:  [40.588 GiB/s 40.617 GiB/s 40.638 GiB/s]
                 change:
                        time:   [+14.093% +14.241% +14.383%] (p = 0.00 < 0.05)
                        thrpt:  [−12.575% −12.466% −12.352%]
                        Performance has regressed.
Found 4 outliers among 100 measurements (4.00%)
  2 (2.00%) high mild
  2 (2.00%) high severe
...
Benchmarking network/blockfetch/msg_block/decode/90000: Collecting 100 samples in estimated 5.0038 s (2.4M iterations)
Benchmarking network/blockfetch/msg_block/decode/90000: Analyzing
network/blockfetch/msg_block/decode/90000
                        time:   [2.0526 µs 2.0597 µs 2.0711 µs]
                        thrpt:  [40.474 GiB/s 40.698 GiB/s 40.838 GiB/s]
                 change:
                        time:   [+14.616% +14.948% +15.381%] (p = 0.00 < 0.05)
                        thrpt:  [−13.330% −13.004% −12.752%]
                        Performance has regressed.
...
network/blockfetch/request_range/encode
                        time:   [105.34 ns 105.48 ns 105.68 ns]
                        change: [+17.991% +19.155% +20.376%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 9 outliers among 100 measurements (9.00%)
  1 (1.00%) low mild
  3 (3.00%) high mild
...
network/blockfetch/request_range/decode
                        time:   [69.394 ns 69.932 ns 70.498 ns]
                        change: [+35.492% +36.563% +37.656%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high mild
...
Benchmarking network/n2c_query_encode/pparams/hfc_success: Collecting 100 samples in estimated 5.0000 s (91M iterations)
Benchmarking network/n2c_query_encode/pparams/hfc_success: Analyzing
network/n2c_query_encode/pparams/hfc_success
                        time:   [54.325 ns 54.591 ns 54.908 ns]
                        thrpt:  [1.5435 GiB/s 1.5525 GiB/s 1.5601 GiB/s]
                 change:
                        time:   [+28.223% +29.275% +30.303%] (p = 0.00 < 0.05)
                        thrpt:  [−23.256% −22.645% −22.011%]
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  6 (6.00%) high severe
...
Benchmarking network/n2c_query_encode/pparams/tag24: Collecting 100 samples in estimated 5.0000 s (88M iterations)
Benchmarking network/n2c_query_encode/pparams/tag24: Analyzing
network/n2c_query_encode/pparams/tag24
                        time:   [53.939 ns 54.006 ns 54.114 ns]
                        thrpt:  [1.5661 GiB/s 1.5693 GiB/s 1.5712 GiB/s]
                 change:
                        time:   [+15.456% +15.806% +16.325%] (p = 0.00 < 0.05)
                        thrpt:  [−14.034% −13.649% −13.387%]
                        Performance has regressed.
Found 10 outliers among 100 measurements (10.00%)
  4 (4.00%) high mild
  6 (6.00%) high severe
...
network/n2c_query_encode/govstate/hfc_success
                        time:   [81.446 ns 81.651 ns 82.013 ns]
                        thrpt:  [8.8802 GiB/s 8.9196 GiB/s 8.9420 GiB/s]
                 change:
                        time:   [+26.130% +26.863% +27.672%] (p = 0.00 < 0.05)
                        thrpt:  [−21.674% −21.175% −20.717%]
                        Performance has regressed.
Found 7 outliers among 100 measurements (7.00%)
  2 (2.00%) high mild
  5 (5.00%) high severe
...
Benchmarking network/n2c_query_encode/govstate/tag24: Collecting 100 samples in estimated 5.0003 s (53M iterations)
Benchmarking network/n2c_query_encode/govstate/tag24: Analyzing
network/n2c_query_encode/govstate/tag24
                        time:   [91.517 ns 91.576 ns 91.637 ns]
                        thrpt:  [7.9476 GiB/s 7.9529 GiB/s 7.9580 GiB/s]
                 change:
                        time:   [+17.412% +17.752% +18.054%] (p = 0.00 < 0.05)
                        thrpt:  [−15.293% −15.076% −14.830%]
                        Performance has regressed.
Found 4 outliers among 100 measurements (4.00%)
  2 (2.00%) high mild
  2 (2.00%) high severe
...
network/n2c_query_encode/era_mismatch
                        time:   [24.105 ns 24.235 ns 24.392 ns]
                        thrpt:  [29.857 GiB/s 30.052 GiB/s 30.213 GiB/s]
                 change:
                        time:   [+7.8800% +8.2558% +8.6380%] (p = 0.00 < 0.05)
                        thrpt:  [−7.9512% −7.6262% −7.3044%]
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
...
Benchmarking consensus/vrf_leader_check/single/sigma=0.0000247: Collecting 100 samples in estimated 5.0828 s (157k iterations)
...
consensus/vrf_leader_check/single/sigma=0.0000247
                        time:   [32.134 µs 32.264 µs 32.512 µs]
                        change: [−17.653% −17.336% −16.993%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 9 outliers among 100 measurements (9.00%)
  3 (3.00%) high mild
  6 (6.00%) high severe
...
Benchmarking consensus/vrf_leader_check/single/sigma=0.001: Collecting 100 samples in estimated 5.0324 s (157k iterations)
Benchmarking consensus/vrf_leader_check/single/sigma=0.001: Analyzing
consensus/vrf_leader_check/single/sigma=0.001
                        time:   [32.086 µs 32.277 µs 32.614 µs]
                        change: [−18.467% −17.999% −17.467%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 12 outliers among 100 measurements (12.00%)
  4 (4.00%) high mild
  8 (8.00%) high severe
...
Benchmarking consensus/vrf_leader_check/single/sigma=0.01: Collecting 100 samples in estimated 5.0302 s (157k iterations)
Benchmarking consensus/vrf_leader_check/single/sigma=0.01: Analyzing
consensus/vrf_leader_check/single/sigma=0.01
                        time:   [32.137 µs 32.163 µs 32.197 µs]
                        change: [−20.196% −19.239% −18.505%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 7 outliers among 100 measurements (7.00%)
  2 (2.00%) high mild
  5 (5.00%) high severe
...
Benchmarking consensus/vrf_leader_check/batch/21600: Collecting 20 samples in estimated 13.789 s (20 iterations)
Benchmarking consensus/vrf_leader_check/batch/21600: Analyzing
consensus/vrf_leader_check/batch/21600
                        time:   [690.99 ms 691.91 ms 693.49 ms]
                        thrpt:  [31.147 Kelem/s 31.218 Kelem/s 31.259 Kelem/s]
                 change:
                        time:   [−18.835% −18.456% −18.154%] (p = 0.00 < 0.05)
                        thrpt:  [+22.181% +22.633% +23.206%]
                        Performance has improved.
Found 1 outliers among 20 measurements (5.00%)
  1 (5.00%) high severe
...
Benchmarking consensus/validate_header/replay_mode: Collecting 100 samples in estimated 5.0000 s (571M iterations)
Benchmarking consensus/validate_header/replay_mode: Analyzing
consensus/validate_header/replay_mode
                        time:   [8.7741 ns 8.7916 ns 8.8110 ns]
                        change: [−24.021% −23.754% −23.372%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 5 outliers among 100 measurements (5.00%)
  3 (3.00%) high mild
  2 (2.00%) high severe
...
consensus/chain_selection/longer_fork_100
                        time:   [1.3632 ns 1.3634 ns 1.3637 ns]
                        change: [−12.424% −12.300% −12.144%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 9 outliers among 100 measurements (9.00%)
  1 (1.00%) low mild
  2 (2.00%) high mild
...
Benchmarking consensus/chain_selection/equal_length_tiebreak: Collecting 100 samples in estimated 5.0006 s (19M iterations)
Benchmarking consensus/chain_selection/equal_length_tiebreak: Analyzing
consensus/chain_selection/equal_length_tiebreak
                        time:   [266.85 ns 267.14 ns 267.42 ns]
                        change: [−19.113% −18.940% −18.776%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high mild
...
consensus/chain_selection/prefer_simple
                        time:   [2.0482 ns 2.0518 ns 2.0554 ns]
                        change: [−15.554% −15.368% −15.179%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) low mild
  1 (1.00%) high mild
...
Benchmarking lsm/insert/random_keys/10000: Collecting 10 samples in estimated 5.0244 s (2365 iterations)
Benchmarking lsm/insert/random_keys/10000: Analyzing
lsm/insert/random_keys/10000
                        time:   [1.9312 ms 1.9567 ms 2.0232 ms]
                        thrpt:  [4.9426 Melem/s 5.1107 Melem/s 5.1781 Melem/s]
                 change:
                        time:   [−39.925% −37.567% −35.232%] (p = 0.00 < 0.05)
                        thrpt:  [+54.397% +60.172% +66.458%]
                        Performance has improved.

Benchmarking lsm/point_lookup/hit_random/10000
Benchmarking lsm/point_lookup/hit_random/10000: Warming up for 3.0000 s
Benchmarking lsm/point_lookup/hit_random/10000: Collecting 100 samples in estimated 5.5339 s (20k iterations)
Benchmarking lsm/point_lookup/hit_random/10000: Analyzing
lsm/point_lookup/hit_random/10000
                        time:   [280.41 µs 284.17 µs 288.49 µs]
                        thrpt:  [3.4663 Melem/s 3.5190 Melem/s 3.5662 Melem/s]
                 change:
                        time:   [−33.273% −32.501% −31.574%] (p = 0.00 < 0.05)
                        thrpt:  [+46.144% +48.150% +49.865%]
                        Performance has improved.
Benchmarking lsm/point_lookup/miss_random/10000
Benchmarking lsm/point_lookup/miss_random/10000: Warming up for 3.0000 s
Benchmarking lsm/point_lookup/miss_random/10000: Collecting 100 samples in estimated 5.2525 s (81k iterations)
Benchmarking lsm/point_lookup/miss_random/10000: Analyzing
lsm/point_lookup/miss_random/10000
                        time:   [65.748 µs 66.443 µs 67.297 µs]
                        thrpt:  [14.860 Melem/s 15.050 Melem/s 15.210 Melem/s]
                 change:
                        time:   [−28.971% −28.213% −27.303%] (p = 0.00 < 0.05)
                        thrpt:  [+37.558% +39.301% +40.788%]
                        Performance has improved.
...
Benchmarking lsm/range_scan/window_100_of_10k/10000: Collecting 20 samples in estimated 5.0060 s (114k iterations)
Benchmarking lsm/range_scan/window_100_of_10k/10000: Analyzing
lsm/range_scan/window_100_of_10k/10000
                        time:   [43.051 µs 47.273 µs 50.754 µs]
                        thrpt:  [1.9703 Melem/s 2.1154 Melem/s 2.3228 Melem/s]
                 change:
                        time:   [−30.007% −27.601% −24.362%] (p = 0.00 < 0.05)
                        thrpt:  [+32.208% +38.123% +42.871%]
                        Performance has improved.
...
Benchmarking lsm/range_scan/full_scan/10000: Collecting 20 samples in estimated 5.1634 s (4200 iterations)
Benchmarking lsm/range_scan/full_scan/10000: Analyzing
lsm/range_scan/full_scan/10000
                        time:   [1.1949 ms 1.2776 ms 1.3383 ms]
                        thrpt:  [7.4723 Melem/s 7.8272 Melem/s 8.3690 Melem/s]
                 change:
                        time:   [−28.260% −26.748% −24.613%] (p = 0.00 < 0.05)
                        thrpt:  [+32.649% +36.516% +39.391%]
                        Performance has improved.
Found 4 outliers among 20 measurements (20.00%)
  1 (5.00%) high mild
  3 (15.00%) high severe
...
Benchmarking lsm/apply_batch/inserts_10k_deletes_2.5k/10000: Collecting 10 samples in estimated 5.2394 s (715 iterations)
Benchmarking lsm/apply_batch/inserts_10k_deletes_2.5k/10000: Analyzing
lsm/apply_batch/inserts_10k_deletes_2.5k/10000
                        time:   [3.4844 ms 3.4923 ms 3.5003 ms]
                        thrpt:  [2.8569 Melem/s 2.8634 Melem/s 2.8699 Melem/s]
                 change:
                        time:   [−35.587% −35.438% −35.283%] (p = 0.00 < 0.05)
                        thrpt:  [+54.518% +54.890% +55.249%]
                        Performance has improved.

Benchmarking lsm/snapshot/save_10k
Benchmarking lsm/snapshot/save_10k: Warming up for 3.0000 s
Benchmarking lsm/snapshot/save_10k: Collecting 10 samples in estimated 5.1465 s (1265 iterations)
Benchmarking lsm/snapshot/save_10k: Analyzing
lsm/snapshot/save_10k   time:   [213.11 µs 215.92 µs 218.92 µs]
                        change: [−59.956% −59.424% −58.852%] (p = 0.00 < 0.05)
                        Performance has improved.
Benchmarking lsm/snapshot/load_10k
Benchmarking lsm/snapshot/load_10k: Warming up for 3.0000 s
Benchmarking lsm/snapshot/load_10k: Collecting 10 samples in estimated 5.0095 s (990 iterations)
Benchmarking lsm/snapshot/load_10k: Analyzing
lsm/snapshot/load_10k   time:   [1.0550 ms 1.0762 ms 1.1056 ms]
                        change: [−38.784% −37.895% −36.688%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 10 measurements (20.00%)
  1 (10.00%) high mild
  1 (10.00%) high severe
...
Benchmarking mempool/add/txs/1000: Collecting 100 samples in estimated 9.5725 s (10k iterations)
Benchmarking mempool/add/txs/1000: Analyzing
mempool/add/txs/1000    time:   [876.28 µs 877.90 µs 879.59 µs]
                        change: [+29.624% +29.905% +30.178%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 3 outliers among 100 measurements (3.00%)
  1 (1.00%) low mild
  2 (2.00%) high mild
...
Benchmarking mempool/add/txs/5000: Collecting 100 samples in estimated 5.3329 s (800 iterations)
Benchmarking mempool/add/txs/5000: Analyzing
mempool/add/txs/5000    time:   [6.2042 ms 6.3743 ms 6.5446 ms]
                        change: [−1.6846% +1.0556% +4.0554%] (p = 0.49 > 0.05)
                        No change in performance detected.
Benchmarking mempool/add/txs/10000
Benchmarking mempool/add/txs/10000: Warming up for 3.0000 s
Benchmarking mempool/add/txs/10000: Collecting 100 samples in estimated 5.1418 s (400 iterations)
Benchmarking mempool/add/txs/10000: Analyzing
mempool/add/txs/10000   time:   [11.726 ms 12.068 ms 12.422 ms]
                        change: [+38.656% +43.598% +48.973%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking mempool/remove/txs/1000: Collecting 100 samples in estimated 6.5953 s (5050 iterations)
Benchmarking mempool/remove/txs/1000: Analyzing
mempool/remove/txs/1000 time:   [493.12 µs 494.49 µs 496.00 µs]
                        change: [+32.540% +33.083% +33.571%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) low mild
Benchmarking mempool/remove/txs/5000
Benchmarking mempool/remove/txs/5000: Warming up for 3.0000 s
Benchmarking mempool/remove/txs/5000: Collecting 100 samples in estimated 5.0216 s (700 iterations)
Benchmarking mempool/remove/txs/5000: Analyzing
mempool/remove/txs/5000 time:   [2.7807 ms 2.7902 ms 2.7997 ms]
                        change: [+25.004% +25.474% +25.963%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high mild
Benchmarking mempool/remove/txs/10000
Benchmarking mempool/remove/txs/10000: Warming up for 3.0000 s
Benchmarking mempool/remove/txs/10000: Collecting 100 samples in estimated 6.2109 s (400 iterations)
Benchmarking mempool/remove/txs/10000: Analyzing
mempool/remove/txs/10000
                        time:   [6.1823 ms 6.2036 ms 6.2250 ms]
                        change: [+26.066% +26.752% +27.386%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking mempool/get_sorted/by_fee_density/1000: Collecting 100 samples in estimated 5.0792 s (81k iterations)
Benchmarking mempool/get_sorted/by_fee_density/1000: Analyzing
mempool/get_sorted/by_fee_density/1000
                        time:   [62.894 µs 63.059 µs 63.213 µs]
                        change: [+9.3513% +9.8419% +10.265%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high mild
...
Benchmarking mempool/get_sorted/by_fee_density/5000: Collecting 100 samples in estimated 5.3278 s (76k iterations)
Benchmarking mempool/get_sorted/by_fee_density/5000: Analyzing
mempool/get_sorted/by_fee_density/5000
                        time:   [70.625 µs 70.764 µs 70.899 µs]
                        change: [+24.714% +25.367% +26.088%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) low mild
  1 (1.00%) high severe
...
Benchmarking mempool/get_sorted/by_fee_density/10000: Collecting 100 samples in estimated 5.2974 s (76k iterations)
Benchmarking mempool/get_sorted/by_fee_density/10000: Analyzing
mempool/get_sorted/by_fee_density/10000
                        time:   [70.265 µs 70.473 µs 70.724 µs]
                        change: [+34.445% +35.129% +35.905%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  2 (2.00%) low mild
  1 (1.00%) high mild
...
Benchmarking mempool/drain_readd/txs/1000: Collecting 100 samples in estimated 9.0097 s (5050 iterations)
Benchmarking mempool/drain_readd/txs/1000: Analyzing
mempool/drain_readd/txs/1000
                        time:   [934.68 µs 938.87 µs 944.17 µs]
                        change: [+28.349% +28.820% +29.315%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 5 outliers among 100 measurements (5.00%)
  2 (2.00%) low mild
  1 (1.00%) high mild
...
Benchmarking mempool/drain_readd/txs/5000: Collecting 100 samples in estimated 5.6878 s (600 iterations)
Benchmarking mempool/drain_readd/txs/5000: Analyzing
mempool/drain_readd/txs/5000
                        time:   [4.9125 ms 4.9260 ms 4.9398 ms]
                        change: [+23.939% +24.339% +24.714%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) low mild
  1 (1.00%) high severe
...
Benchmarking mempool/drain_readd/txs/10000: Collecting 100 samples in estimated 5.9030 s (300 iterations)
Benchmarking mempool/drain_readd/txs/10000: Analyzing
mempool/drain_readd/txs/10000
                        time:   [10.322 ms 10.387 ms 10.464 ms]
                        change: [+9.0194% +9.8428% +10.839%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 5 outliers among 100 measurements (5.00%)
  2 (2.00%) high mild
  3 (3.00%) high severe
...
Benchmarking mempool/batch_remove/50_from/5000: Collecting 100 samples in estimated 5.0023 s (3.3M iterations)
Benchmarking mempool/batch_remove/50_from/5000: Analyzing
mempool/batch_remove/50_from/5000
                        time:   [1.5548 µs 1.5584 µs 1.5635 µs]
                        change: [+40.409% +40.743% +41.079%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 11 outliers among 100 measurements (11.00%)
  3 (3.00%) low severe
  6 (6.00%) low mild
...
Benchmarking mempool/batch_remove/50_from/10000: Collecting 100 samples in estimated 5.0006 s (3.3M iterations)
Benchmarking mempool/batch_remove/50_from/10000: Analyzing
mempool/batch_remove/50_from/10000
                        time:   [1.5212 µs 1.5241 µs 1.5276 µs]
                        change: [+30.452% +31.882% +33.261%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 13 outliers among 100 measurements (13.00%)
  2 (2.00%) low severe
  3 (3.00%) low mild
...
Benchmarking ed25519_verify/single: Collecting 100 samples in estimated 5.0473 s (121k iterations)
Benchmarking ed25519_verify/single: Analyzing
ed25519_verify/single   time:   [47.512 µs 47.935 µs 48.282 µs]
                        change: [+41.254% +43.572% +45.859%] (p = 0.00 < 0.05)
                        Performance has regressed.

Benchmarking ed25519_batch_verify/sequential/1
Benchmarking ed25519_batch_verify/sequential/1: Warming up for 3.0000 s
Benchmarking ed25519_batch_verify/sequential/1: Collecting 100 samples in estimated 5.0404 s (121k iterations)
Benchmarking ed25519_batch_verify/sequential/1: Analyzing
ed25519_batch_verify/sequential/1
                        time:   [41.460 µs 41.502 µs 41.558 µs]
                        change: [+25.715% +26.200% +26.678%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 8 outliers among 100 measurements (8.00%)
  3 (3.00%) high mild
  5 (5.00%) high severe
...
Benchmarking ed25519_batch_verify/sequential/10: Collecting 100 samples in estimated 6.2983 s (15k iterations)
Benchmarking ed25519_batch_verify/sequential/10: Analyzing
ed25519_batch_verify/sequential/10
                        time:   [416.24 µs 416.83 µs 417.54 µs]
                        change: [+25.409% +26.045% +26.707%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 10 outliers among 100 measurements (10.00%)
  1 (1.00%) high mild
  9 (9.00%) high severe
...
Benchmarking ed25519_batch_verify/sequential/50: Collecting 100 samples in estimated 5.0500 s (2400 iterations)
Benchmarking ed25519_batch_verify/sequential/50: Analyzing
ed25519_batch_verify/sequential/50
                        time:   [2.0976 ms 2.1001 ms 2.1032 ms]
                        change: [+27.596% +28.167% +28.744%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  2 (2.00%) high mild
  4 (4.00%) high severe
...
Benchmarking ed25519_batch_verify/sequential/100: Collecting 100 samples in estimated 5.1038 s (1200 iterations)
Benchmarking ed25519_batch_verify/sequential/100: Analyzing
ed25519_batch_verify/sequential/100
                        time:   [4.2369 ms 4.2412 ms 4.2468 ms]
                        change: [+19.919% +22.011% +24.114%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 5 outliers among 100 measurements (5.00%)
  1 (1.00%) high mild
  4 (4.00%) high severe
...
Benchmarking ed25519_batch_verify/sequential/200: Collecting 100 samples in estimated 5.1288 s (600 iterations)
Benchmarking ed25519_batch_verify/sequential/200: Analyzing
ed25519_batch_verify/sequential/200
                        time:   [8.5034 ms 8.5111 ms 8.5215 ms]
                        change: [+28.003% +28.514% +29.027%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 4 outliers among 100 measurements (4.00%)
  1 (1.00%) high mild
  3 (3.00%) high severe
...
Benchmarking ed25519_batch_verify/sequential/500: Collecting 100 samples in estimated 6.4311 s (300 iterations)
Benchmarking ed25519_batch_verify/sequential/500: Analyzing
ed25519_batch_verify/sequential/500
                        time:   [21.291 ms 21.364 ms 21.495 ms]
                        change: [+28.253% +29.032% +29.996%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high severe
...
keyhash_from_vkey/single
                        time:   [165.28 ns 165.80 ns 166.39 ns]
                        change: [+43.653% +44.069% +44.480%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 18 outliers among 100 measurements (18.00%)
  17 (17.00%) high mild
  1 (1.00%) high severe
...
Benchmarking keyhash_from_vkey/batch/10: Collecting 100 samples in estimated 5.0005 s (3.2M iterations)
Benchmarking keyhash_from_vkey/batch/10: Analyzing
keyhash_from_vkey/batch/10
                        time:   [1.5615 µs 1.5627 µs 1.5641 µs]
                        change: [+32.016% +33.927% +35.864%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) high mild
  1 (1.00%) high severe
...
Benchmarking keyhash_from_vkey/batch/50: Collecting 100 samples in estimated 5.0120 s (636k iterations)
Benchmarking keyhash_from_vkey/batch/50: Analyzing
keyhash_from_vkey/batch/50
                        time:   [7.8079 µs 7.8167 µs 7.8274 µs]
                        change: [+31.559% +33.566% +35.593%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) high mild
  1 (1.00%) high severe
...
Benchmarking keyhash_from_vkey/batch/100: Collecting 100 samples in estimated 5.0121 s (318k iterations)
Benchmarking keyhash_from_vkey/batch/100: Analyzing
keyhash_from_vkey/batch/100
                        time:   [15.617 µs 15.635 µs 15.656 µs]
                        change: [+42.099% +42.373% +42.612%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high severe
Benchmarking keyhash_from_vkey/batch/200
Benchmarking keyhash_from_vkey/batch/200: Warming up for 3.0000 s
Benchmarking keyhash_from_vkey/batch/200: Collecting 100 samples in estimated 5.1146 s (162k iterations)
Benchmarking keyhash_from_vkey/batch/200: Analyzing
keyhash_from_vkey/batch/200
                        time:   [31.251 µs 31.308 µs 31.380 µs]
                        change: [+28.047% +29.896% +31.838%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 7 outliers among 100 measurements (7.00%)
  2 (2.00%) high mild
  5 (5.00%) high severe
...
Benchmarking keyhash_from_vkey/batch/500: Collecting 100 samples in estimated 5.1539 s (66k iterations)
Benchmarking keyhash_from_vkey/batch/500: Analyzing
keyhash_from_vkey/batch/500
                        time:   [78.242 µs 78.289 µs 78.341 µs]
                        change: [+31.371% +33.356% +35.348%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 4 outliers among 100 measurements (4.00%)
  3 (3.00%) high mild
  1 (1.00%) high severe
...
Benchmarking vrf_verify/single_proof: Collecting 100 samples in estimated 5.3452 s (35k iterations)
Benchmarking vrf_verify/single_proof: Analyzing
vrf_verify/single_proof time:   [151.49 µs 151.55 µs 151.62 µs]
                        change: [+67.255% +67.416% +67.597%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  4 (4.00%) high mild
  2 (2.00%) high severe
...
blake2b_256/hash/32B_txhash
                        time:   [164.87 ns 165.22 ns 165.64 ns]
                        change: [+4.4691% +5.0057% +5.5949%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
blake2b_256/hash/64B_vkey
                        time:   [165.21 ns 166.31 ns 167.64 ns]
                        change: [+5.1188% +5.7736% +6.4752%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
blake2b_256/hash/256B_small_tx
                        time:   [297.42 ns 297.61 ns 297.81 ns]
                        change: [+7.0440% +7.2384% +7.4225%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) high mild
  1 (1.00%) high severe
...
Benchmarking blake2b_256/hash/500B_avg_tx: Collecting 100 samples in estimated 5.0012 s (8.7M iterations)
Benchmarking blake2b_256/hash/500B_avg_tx: Analyzing
blake2b_256/hash/500B_avg_tx
                        time:   [575.84 ns 576.15 ns 576.49 ns]
                        change: [+7.3256% +7.4504% +7.5889%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
Benchmarking blake2b_256/hash/1KB_tx_body
Benchmarking blake2b_256/hash/1KB_tx_body: Warming up for 3.0000 s
Benchmarking blake2b_256/hash/1KB_tx_body: Collecting 100 samples in estimated 5.0051 s (4.5M iterations)
Benchmarking blake2b_256/hash/1KB_tx_body: Analyzing
blake2b_256/hash/1KB_tx_body
                        time:   [1.1188 µs 1.1191 µs 1.1193 µs]
                        change: [+6.5969% +6.6843% +6.7725%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  1 (1.00%) low mild
  4 (4.00%) high mild
...
Benchmarking blake2b_256/hash/4KB_large_tx: Collecting 100 samples in estimated 5.0126 s (1.1M iterations)
Benchmarking blake2b_256/hash/4KB_large_tx: Analyzing
blake2b_256/hash/4KB_large_tx
                        time:   [4.4059 µs 4.4066 µs 4.4074 µs]
                        change: [+6.8652% +6.9312% +6.9872%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) low mild
  1 (1.00%) high severe
...
Benchmarking blake2b_256/hash/16KB_block_header: Collecting 100 samples in estimated 5.0593 s (288k iterations)
Benchmarking blake2b_256/hash/16KB_block_header: Analyzing
blake2b_256/hash/16KB_block_header
                        time:   [17.572 µs 17.602 µs 17.654 µs]
                        change: [+7.0629% +7.2348% +7.4533%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 12 outliers among 100 measurements (12.00%)
  12 (12.00%) high severe
Benchmarking blake2b_256/hash/20KB_avg_block
Benchmarking blake2b_256/hash/20KB_avg_block: Warming up for 3.0000 s
Benchmarking blake2b_256/hash/20KB_avg_block: Collecting 100 samples in estimated 5.1036 s (232k iterations)
Benchmarking blake2b_256/hash/20KB_avg_block: Analyzing
blake2b_256/hash/20KB_avg_block
                        time:   [21.951 µs 21.955 µs 21.961 µs]
                        change: [+6.9203% +6.9619% +7.0010%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 5 outliers among 100 measurements (5.00%)
  5 (5.00%) high severe
Benchmarking blake2b_256/hash/90KB_max_block
Benchmarking blake2b_256/hash/90KB_max_block: Warming up for 3.0000 s
Benchmarking blake2b_256/hash/90KB_max_block: Collecting 100 samples in estimated 5.4849 s (56k iterations)
Benchmarking blake2b_256/hash/90KB_max_block: Analyzing
blake2b_256/hash/90KB_max_block
                        time:   [98.724 µs 98.734 µs 98.745 µs]
                        change: [+7.0040% +7.0391% +7.0710%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  1 (1.00%) low mild
  1 (1.00%) high mild
...
blake2b_224/hash/32B_vkey_to_keyhash
                        time:   [174.27 ns 174.56 ns 174.92 ns]
                        change: [+4.6005% +5.1003% +5.6274%] (p = 0.00 < 0.05)
                        Performance has regressed.
Benchmarking blake2b_224/hash/64B_script_bytes
Benchmarking blake2b_224/hash/64B_script_bytes: Warming up for 3.0000 s
Benchmarking blake2b_224/hash/64B_script_bytes: Collecting 100 samples in estimated 5.0001 s (29M iterations)
Benchmarking blake2b_224/hash/64B_script_bytes: Analyzing
blake2b_224/hash/64B_script_bytes
                        time:   [174.55 ns 174.84 ns 175.19 ns]
                        change: [+6.3582% +6.8568% +7.4069%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
blake2b_224/hash/256B_address_payload
                        time:   [306.78 ns 306.96 ns 307.14 ns]
                        change: [+7.5820% +7.7316% +7.8712%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high mild
...
Benchmarking blake2b_batch/256_txbodies_500B/100: Collecting 100 samples in estimated 5.1836 s (91k iterations)
Benchmarking blake2b_batch/256_txbodies_500B/100: Analyzing
blake2b_batch/256_txbodies_500B/100
                        time:   [57.131 µs 57.175 µs 57.218 µs]
                        change: [+7.0715% +7.1766% +7.3008%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
Benchmarking blake2b_batch/256_txbodies_500B/300
Benchmarking blake2b_batch/256_txbodies_500B/300: Warming up for 3.0000 s
Benchmarking blake2b_batch/256_txbodies_500B/300: Collecting 100 samples in estimated 5.1949 s (30k iterations)
Benchmarking blake2b_batch/256_txbodies_500B/300: Analyzing
blake2b_batch/256_txbodies_500B/300
                        time:   [171.36 µs 171.51 µs 171.67 µs]
                        change: [+7.0584% +7.1958% +7.3752%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high severe
...
Benchmarking serialization/encode_transaction/conway_2in_2out_2wit: Collecting 100 samples in estimated 5.0027 s (2.6M iterations)
...
serialization/encode_transaction/conway_2in_2out_2wit
                        time:   [1.9147 µs 1.9176 µs 1.9213 µs]
                        change: [+14.562% +16.505% +19.450%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 15 outliers among 100 measurements (15.00%)
  2 (2.00%) high mild
...
Benchmarking serialization/encode_transaction/body_only_2in_2out: Collecting 100 samples in estimated 5.0008 s (4.0M iterations)
...
serialization/encode_transaction/body_only_2in_2out
                        time:   [1.2364 µs 1.2375 µs 1.2387 µs]
                        change: [−10.014% −9.4362% −8.8364%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 7 outliers among 100 measurements (7.00%)
  4 (4.00%) high mild
  3 (3.00%) high severe
...
Benchmarking serialization/encode_block_header/with_vrf_output: Collecting 100 samples in estimated 5.0035 s (4.6M iterations)
...
serialization/encode_block_header/with_vrf_output
                        time:   [1.0845 µs 1.0868 µs 1.0898 µs]
                        change: [−12.698% −12.124% −11.402%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 7 outliers among 100 measurements (7.00%)
  7 (7.00%) high severe
...
serialization/encode_value/ada_only
                        time:   [22.118 ns 22.134 ns 22.153 ns]
                        change: [−1.2917% −1.0458% −0.8369%] (p = 0.00 < 0.05)
                        Change within noise threshold.
Found 4 outliers among 100 measurements (4.00%)
  1 (1.00%) low mild
  1 (1.00%) high mild
...
serialization/encode_value/multi_asset_3policy_5asset
                        time:   [774.37 ns 775.81 ns 777.49 ns]
                        change: [−0.1992% +0.1775% +0.6045%] (p = 0.43 > 0.05)
                        No change in performance detected.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
