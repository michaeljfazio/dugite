# Nightly Benchmark Results — 2026-09-01

Captured on **2026-09-01** from commit [`3feac08`](https://github.com/MichaelJFazio/dugite/commit/3feac08) on `main` (GitHub Actions `ubuntu-latest`).
...
> The collapsed _Raw measurements_ blocks contain the filtered `cargo bench` output (cargo build chatter and ANSI escapes are stripped). Full unfiltered logs are uploaded as the `benchmark-results-180` workflow artifact.
...
Benchmarking chaindb/sequential_insert/10k_20kb: Collecting 10 samples in estimated 5.7542 s (20 iterations)
Benchmarking chaindb/sequential_insert/10k_20kb: Analyzing
chaindb/sequential_insert/10k_20kb
                        time:   [266.28 ms 270.97 ms 277.60 ms]
                        change: [+1.7592% +4.1764% +6.8617%] (p = 0.01 < 0.05)
...
Benchmarking chaindb/random_read/by_hash/10000blks: Collecting 100 samples in estimated 5.4490 s (15k iterations)
Benchmarking chaindb/random_read/by_hash/10000blks: Analyzing
chaindb/random_read/by_hash/10000blks
                        time:   [358.58 µs 358.77 µs 358.97 µs]
                        change: [+19.895% +20.197% +20.440%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking chaindb/random_read/by_hash/100000blks: Collecting 100 samples in estimated 5.8121 s (400 iterations)
Benchmarking chaindb/random_read/by_hash/100000blks: Analyzing
chaindb/random_read/by_hash/100000blks
                        time:   [14.453 ms 14.597 ms 14.748 ms]
                        change: [−21.015% −19.538% −18.071%] (p = 0.00 < 0.05)
...
chaindb/tip_query       time:   [351.63 ps 351.89 ps 352.21 ps]
                        change: [+11.255% +11.799% +12.274%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
chaindb/has_block       time:   [21.005 µs 21.052 µs 21.097 µs]
                        change: [−9.3848% −8.0697% −6.7124%] (p = 0.00 < 0.05)
                        Performance has improved.
...
chaindb/slot_range_100  time:   [260.73 ns 261.11 ns 261.50 ns]
                        change: [+4.9059% +5.4914% +6.0423%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking chaindb/flush_to_immutable/k_2160_blocks_20kb/2160: Collecting 10 samples in estimated 6.3396 s (110 iterations)
...
chaindb/flush_to_immutable/k_2160_blocks_20kb/2160
                        time:   [7.3937 ms 7.4499 ms 7.5462 ms]
                        change: [−1.8706% −0.4321% +1.0324%] (p = 0.59 > 0.05)
...
Benchmarking chaindb/profile_comparison/insert_10k_20kb/in_memory: Collecting 10 samples in estimated 5.3187 s (20 iterations)
...
chaindb/profile_comparison/insert_10k_20kb/in_memory
                        time:   [267.57 ms 272.09 ms 280.08 ms]
                        change: [+1.9226% +4.2377% +7.5692%] (p = 0.01 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
Benchmarking chaindb/profile_comparison/insert_10k_20kb/mmap: Collecting 10 samples in estimated 5.5109 s (20 iterations)
Benchmarking chaindb/profile_comparison/insert_10k_20kb/mmap: Analyzing
chaindb/profile_comparison/insert_10k_20kb/mmap
                        time:   [269.23 ms 270.97 ms 272.85 ms]
                        change: [+3.0115% +3.9444% +5.0427%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
Benchmarking chaindb/profile_comparison/read_500/in_memory: Collecting 10 samples in estimated 5.3643 s (20 iterations)
Benchmarking chaindb/profile_comparison/read_500/in_memory: Analyzing
chaindb/profile_comparison/read_500/in_memory
                        time:   [34.597 ms 34.907 ms 35.180 ms]
                        change: [−1.0324% +0.5566% +2.1921%] (p = 0.52 > 0.05)
                        No change in performance detected.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) low mild
...
Benchmarking chaindb/profile_comparison/read_500/mmap: Collecting 10 samples in estimated 5.4104 s (20 iterations)
Benchmarking chaindb/profile_comparison/read_500/mmap: Analyzing
chaindb/profile_comparison/read_500/mmap
                        time:   [34.857 ms 35.162 ms 35.449 ms]
                        change: [−1.3426% +0.0887% +1.4483%] (p = 0.91 > 0.05)
                        No change in performance detected.
...
Benchmarking immutabledb/open/in_memory/10000: Collecting 100 samples in estimated 7.2970 s (200 iterations)
Benchmarking immutabledb/open/in_memory/10000: Analyzing
immutabledb/open/in_memory/10000
                        time:   [36.370 ms 36.433 ms 36.503 ms]
                        change: [−62.638% −62.552% −62.468%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 3 outliers among 100 measurements (3.00%)
  2 (2.00%) low mild
  1 (1.00%) high severe
...
Benchmarking immutabledb/open/mmap_cached/10000: Collecting 100 samples in estimated 7.5298 s (200 iterations)
Benchmarking immutabledb/open/mmap_cached/10000: Analyzing
immutabledb/open/mmap_cached/10000
                        time:   [36.376 ms 36.448 ms 36.520 ms]
                        change: [−62.544% −62.459% −62.370%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high mild
...
Benchmarking immutabledb/open/mmap_cold_rebuild/10000: Collecting 100 samples in estimated 7.5226 s (200 iterations)
Benchmarking immutabledb/open/mmap_cold_rebuild/10000: Analyzing
immutabledb/open/mmap_cold_rebuild/10000
                        time:   [36.235 ms 36.292 ms 36.350 ms]
                        change: [−63.291% −62.881% −62.645%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking immutabledb/open/in_memory/100000: Collecting 100 samples in estimated 35.651 s (100 iterations)
Benchmarking immutabledb/open/in_memory/100000: Analyzing
immutabledb/open/in_memory/100000
                        time:   [297.17 ms 298.12 ms 299.32 ms]
                        change: [−67.550% −67.316% −67.113%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 7 outliers among 100 measurements (7.00%)
  2 (2.00%) high mild
  5 (5.00%) high severe
...
Benchmarking immutabledb/open/mmap_cached/100000: Collecting 100 samples in estimated 33.587 s (100 iterations)
Benchmarking immutabledb/open/mmap_cached/100000: Analyzing
immutabledb/open/mmap_cached/100000
                        time:   [296.67 ms 296.99 ms 297.33 ms]
                        change: [−67.367% −67.320% −67.275%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high mild
...
Benchmarking immutabledb/open/mmap_cold_rebuild/100000: Collecting 100 samples in estimated 29.789 s (100 iterations)
Benchmarking immutabledb/open/mmap_cold_rebuild/100000: Analyzing
immutabledb/open/mmap_cold_rebuild/100000
                        time:   [302.60 ms 303.36 ms 304.13 ms]
                        change: [−66.721% −66.633% −66.553%] (p = 0.00 < 0.05)
                        Performance has improved.

Benchmarking immutabledb/lookup/in_memory/10000
Benchmarking immutabledb/lookup/in_memory/10000: Warming up for 3.0000 s
Benchmarking immutabledb/lookup/in_memory/10000: Collecting 100 samples in estimated 6.1359 s (500 iterations)
Benchmarking immutabledb/lookup/in_memory/10000: Analyzing
immutabledb/lookup/in_memory/10000
                        time:   [12.557 ms 12.625 ms 12.692 ms]
                        change: [+5.2202% +5.8914% +6.6342%] (p = 0.00 < 0.05)
                        Performance has regressed.
Benchmarking immutabledb/lookup/mmap/10000
Benchmarking immutabledb/lookup/mmap/10000: Warming up for 3.0000 s
Benchmarking immutabledb/lookup/mmap/10000: Collecting 100 samples in estimated 6.0809 s (500 iterations)
Benchmarking immutabledb/lookup/mmap/10000: Analyzing
immutabledb/lookup/mmap/10000
                        time:   [12.456 ms 12.560 ms 12.683 ms]
                        change: [+4.8500% +5.8158% +6.9164%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
...
Benchmarking immutabledb/has_block/in_memory: Collecting 100 samples in estimated 5.1126 s (162k iterations)
Benchmarking immutabledb/has_block/in_memory: Analyzing
immutabledb/has_block/in_memory
                        time:   [31.759 µs 31.872 µs 31.980 µs]
                        change: [−12.608% −10.012% −7.4492%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
Benchmarking immutabledb/has_block/mmap
Benchmarking immutabledb/has_block/mmap: Warming up for 3.0000 s
Benchmarking immutabledb/has_block/mmap: Collecting 100 samples in estimated 5.0688 s (162k iterations)
Benchmarking immutabledb/has_block/mmap: Analyzing
immutabledb/has_block/mmap
                        time:   [31.757 µs 31.870 µs 31.977 µs]
                        change: [−12.624% −10.002% −7.4397%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
...
Benchmarking immutabledb/append/1k_blocks_20kb/in_memory: Collecting 100 samples in estimated 5.2628 s (300 iterations)
Benchmarking immutabledb/append/1k_blocks_20kb/in_memory: Analyzing
immutabledb/append/1k_blocks_20kb/in_memory
                        time:   [17.368 ms 17.397 ms 17.428 ms]
                        change: [+3.7697% +4.0072% +4.2630%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high mild
...
Benchmarking immutabledb/append/1k_blocks_20kb/mmap: Collecting 100 samples in estimated 5.4776 s (300 iterations)
Benchmarking immutabledb/append/1k_blocks_20kb/mmap: Analyzing
immutabledb/append/1k_blocks_20kb/mmap
                        time:   [18.267 ms 18.324 ms 18.389 ms]
                        change: [+4.4209% +5.0219% +5.5483%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking immutabledb/slot_range/range_100/in_memory: Collecting 100 samples in estimated 5.3189 s (15k iterations)
Benchmarking immutabledb/slot_range/range_100/in_memory: Analyzing
immutabledb/slot_range/range_100/in_memory
                        time:   [342.71 µs 343.41 µs 344.20 µs]
                        change: [+0.3586% +0.9919% +1.6359%] (p = 0.00 < 0.05)
...
Benchmarking immutabledb/slot_range/range_100/mmap: Collecting 100 samples in estimated 5.2890 s (15k iterations)
Benchmarking immutabledb/slot_range/range_100/mmap: Analyzing
immutabledb/slot_range/range_100/mmap
                        time:   [343.32 µs 344.77 µs 346.38 µs]
                        change: [−4.1473% −2.9449% −1.9549%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking block_index/insert/in_memory/10000: Collecting 100 samples in estimated 7.8908 s (10k iterations)
Benchmarking block_index/insert/in_memory/10000: Analyzing
block_index/insert/in_memory/10000
                        time:   [782.94 µs 783.91 µs 784.83 µs]
                        change: [−2.6577% −2.3932% −2.1423%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high severe
Benchmarking block_index/insert/mmap/10000
Benchmarking block_index/insert/mmap/10000: Warming up for 3.0000 s
Benchmarking block_index/insert/mmap/10000: Collecting 100 samples in estimated 5.5752 s (900 iterations)
Benchmarking block_index/insert/mmap/10000: Analyzing
block_index/insert/mmap/10000
                        time:   [6.1587 ms 6.1727 ms 6.1875 ms]
                        change: [+2.7392% +3.1967% +3.5999%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) high mild
  1 (1.00%) high severe
...
Benchmarking block_index/insert/in_memory/50000: Collecting 100 samples in estimated 5.0863 s (1500 iterations)
Benchmarking block_index/insert/in_memory/50000: Analyzing
block_index/insert/in_memory/50000
                        time:   [3.3880 ms 3.3921 ms 3.3964 ms]
                        change: [−4.0623% −3.7335% −3.3967%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high mild
Benchmarking block_index/insert/mmap/50000
Benchmarking block_index/insert/mmap/50000: Warming up for 3.0000 s
Benchmarking block_index/insert/mmap/50000: Collecting 100 samples in estimated 8.2267 s (200 iterations)
Benchmarking block_index/insert/mmap/50000: Analyzing
block_index/insert/mmap/50000
                        time:   [40.727 ms 40.822 ms 40.933 ms]
                        change: [+2.6164% +3.1809% +3.7005%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 7 outliers among 100 measurements (7.00%)
  3 (3.00%) high mild
  4 (4.00%) high severe
...
Benchmarking block_index/insert/in_memory/100000: Collecting 100 samples in estimated 5.5209 s (800 iterations)
Benchmarking block_index/insert/in_memory/100000: Analyzing
block_index/insert/in_memory/100000
                        time:   [6.8174 ms 6.8283 ms 6.8412 ms]
                        change: [−22.648% −21.114% −19.543%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 3 outliers among 100 measurements (3.00%)
  2 (2.00%) high mild
  1 (1.00%) high severe
...
Benchmarking block_index/insert/mmap/100000: Collecting 100 samples in estimated 8.0534 s (100 iterations)
Benchmarking block_index/insert/mmap/100000: Analyzing
block_index/insert/mmap/100000
                        time:   [80.692 ms 80.802 ms 80.927 ms]
                        change: [+0.7997% +1.5353% +2.0844%] (p = 0.00 < 0.05)
                        Change within noise threshold.
Found 4 outliers among 100 measurements (4.00%)
  3 (3.00%) high mild
  1 (1.00%) high severe
...
Benchmarking block_index/lookup/in_memory/10000: Collecting 100 samples in estimated 5.0823 s (298k iterations)
Benchmarking block_index/lookup/in_memory/10000: Analyzing
block_index/lookup/in_memory/10000
                        time:   [17.066 µs 17.099 µs 17.135 µs]
                        change: [−6.8816% −6.6712% −6.4454%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high severe
Benchmarking block_index/lookup/mmap/10000
Benchmarking block_index/lookup/mmap/10000: Warming up for 3.0000 s
Benchmarking block_index/lookup/mmap/10000: Collecting 100 samples in estimated 5.0345 s (187k iterations)
Benchmarking block_index/lookup/mmap/10000: Analyzing
block_index/lookup/mmap/10000
                        time:   [26.991 µs 27.026 µs 27.072 µs]
                        change: [−0.0821% +0.4970% +1.0933%] (p = 0.10 > 0.05)
                        No change in performance detected.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) high mild
  1 (1.00%) high severe
...
Benchmarking block_index/lookup/in_memory/50000: Collecting 100 samples in estimated 5.0841 s (288k iterations)
Benchmarking block_index/lookup/in_memory/50000: Analyzing
block_index/lookup/in_memory/50000
                        time:   [17.708 µs 17.732 µs 17.758 µs]
                        change: [−7.5035% −6.4236% −5.5614%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
Benchmarking block_index/lookup/mmap/50000
Benchmarking block_index/lookup/mmap/50000: Warming up for 3.0000 s
Benchmarking block_index/lookup/mmap/50000: Collecting 100 samples in estimated 5.1003 s (247k iterations)
Benchmarking block_index/lookup/mmap/50000: Analyzing
block_index/lookup/mmap/50000
                        time:   [20.679 µs 20.701 µs 20.722 µs]
                        change: [+1.4087% +1.8159% +2.2516%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking block_index/lookup/in_memory/100000: Collecting 100 samples in estimated 5.0346 s (283k iterations)
Benchmarking block_index/lookup/in_memory/100000: Analyzing
block_index/lookup/in_memory/100000
                        time:   [17.854 µs 17.875 µs 17.895 µs]
                        change: [−5.5944% −5.1794% −4.8696%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 3 outliers among 100 measurements (3.00%)
  2 (2.00%) high mild
  1 (1.00%) high severe
...
Benchmarking block_index/lookup/mmap/100000: Collecting 100 samples in estimated 5.0157 s (247k iterations)
Benchmarking block_index/lookup/mmap/100000: Analyzing
block_index/lookup/mmap/100000
                        time:   [20.376 µs 20.408 µs 20.437 µs]
                        change: [+2.3932% +2.8351% +3.2896%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high mild
...
Benchmarking block_index/contains_miss/in_memory: Collecting 100 samples in estimated 5.0430 s (419k iterations)
Benchmarking block_index/contains_miss/in_memory: Analyzing
block_index/contains_miss/in_memory
                        time:   [12.017 µs 12.037 µs 12.076 µs]
                        change: [−0.7060% −0.2398% +0.3041%] (p = 0.39 > 0.05)
                        No change in performance detected.
...
Benchmarking block_index/contains_miss/mmap: Collecting 100 samples in estimated 5.1664 s (126k iterations)
Benchmarking block_index/contains_miss/mmap: Analyzing
block_index/contains_miss/mmap
                        time:   [40.104 µs 40.234 µs 40.372 µs]
                        change: [−4.4177% −3.2976% −2.1380%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking scaling/block_index_insert/in_memory/10000: Collecting 10 samples in estimated 5.0399 s (6490 iterations)
Benchmarking scaling/block_index_insert/in_memory/10000: Analyzing
scaling/block_index_insert/in_memory/10000
                        time:   [776.07 µs 776.83 µs 777.31 µs]
                        change: [−2.6386% −2.3337% −2.0869%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 3 outliers among 10 measurements (30.00%)
  2 (20.00%) low mild
  1 (10.00%) high severe
...
Benchmarking scaling/block_index_insert/mmap/10000: Collecting 10 samples in estimated 5.0914 s (825 iterations)
Benchmarking scaling/block_index_insert/mmap/10000: Analyzing
scaling/block_index_insert/mmap/10000
                        time:   [6.1420 ms 6.1732 ms 6.2005 ms]
                        change: [+2.4536% +2.8756% +3.2695%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) low mild
...
Benchmarking scaling/block_index_insert/in_memory/50000: Collecting 10 samples in estimated 5.0312 s (1485 iterations)
Benchmarking scaling/block_index_insert/in_memory/50000: Analyzing
scaling/block_index_insert/in_memory/50000
                        time:   [3.3773 ms 3.3876 ms 3.4051 ms]
                        change: [−4.7828% −3.1612% −1.9824%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
Benchmarking scaling/block_index_insert/mmap/50000: Collecting 10 samples in estimated 6.7565 s (165 iterations)
Benchmarking scaling/block_index_insert/mmap/50000: Analyzing
scaling/block_index_insert/mmap/50000
                        time:   [40.878 ms 40.931 ms 40.992 ms]
                        change: [+3.9507% +4.1902% +4.4401%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
Benchmarking scaling/block_index_insert/in_memory/100000: Collecting 10 samples in estimated 5.2936 s (770 iterations)
Benchmarking scaling/block_index_insert/in_memory/100000: Analyzing
scaling/block_index_insert/in_memory/100000
                        time:   [6.8711 ms 6.8935 ms 6.9338 ms]
                        change: [−20.710% −16.854% −13.558%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking scaling/block_index_insert/mmap/100000: Collecting 10 samples in estimated 9.0115 s (110 iterations)
Benchmarking scaling/block_index_insert/mmap/100000: Analyzing
scaling/block_index_insert/mmap/100000
                        time:   [81.333 ms 81.919 ms 82.801 ms]
                        change: [+2.4726% +2.9817% +3.7892%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
Benchmarking scaling/block_index_lookup/in_memory/10000: Collecting 10 samples in estimated 5.0006 s (288k iterations)
Benchmarking scaling/block_index_lookup/in_memory/10000: Analyzing
scaling/block_index_lookup/in_memory/10000
                        time:   [17.174 µs 17.188 µs 17.208 µs]
                        change: [−6.2347% −5.9494% −5.6482%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 10 measurements (20.00%)
  2 (20.00%) high severe
...
scaling/block_index_lookup/mmap/10000
                        time:   [26.789 µs 26.802 µs 26.816 µs]
                        change: [+1.9203% +3.6168% +4.6559%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
Benchmarking scaling/block_index_lookup/in_memory/50000: Collecting 10 samples in estimated 5.0002 s (280k iterations)
Benchmarking scaling/block_index_lookup/in_memory/50000: Analyzing
scaling/block_index_lookup/in_memory/50000
                        time:   [17.654 µs 17.662 µs 17.668 µs]
                        change: [−5.8147% −5.5551% −5.2840%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
scaling/block_index_lookup/mmap/50000
                        time:   [20.572 µs 20.583 µs 20.591 µs]
                        change: [+3.8020% +5.2070% +5.9933%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 10 measurements (20.00%)
  1 (10.00%) high mild
  1 (10.00%) high severe
...
Benchmarking scaling/block_index_lookup/in_memory/100000: Collecting 10 samples in estimated 5.0008 s (278k iterations)
Benchmarking scaling/block_index_lookup/in_memory/100000: Analyzing
scaling/block_index_lookup/in_memory/100000
                        time:   [17.794 µs 17.805 µs 17.815 µs]
                        change: [−5.3097% −5.1003% −4.8709%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
scaling/block_index_lookup/mmap/100000
                        time:   [20.267 µs 20.279 µs 20.299 µs]
                        change: [+4.5562% +5.9688% +6.7444%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking scaling/immutabledb_open/in_memory/10000: Collecting 10 samples in estimated 5.7222 s (165 iterations)
Benchmarking scaling/immutabledb_open/in_memory/10000: Analyzing
scaling/immutabledb_open/in_memory/10000
                        time:   [34.163 ms 34.511 ms 34.915 ms]
                        change: [−65.299% −65.007% −64.661%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
Benchmarking scaling/immutabledb_open/mmap_cached/10000: Collecting 10 samples in estimated 5.6052 s (165 iterations)
Benchmarking scaling/immutabledb_open/mmap_cached/10000: Analyzing
scaling/immutabledb_open/mmap_cached/10000
                        time:   [33.788 ms 34.165 ms 34.613 ms]
                        change: [−65.648% −65.351% −65.015%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
Benchmarking scaling/immutabledb_open/in_memory/50000: Collecting 10 samples in estimated 8.1497 s (55 iterations)
Benchmarking scaling/immutabledb_open/in_memory/50000: Analyzing
scaling/immutabledb_open/in_memory/50000
                        time:   [148.11 ms 149.88 ms 152.89 ms]
                        change: [−67.560% −67.205% −66.744%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 10 measurements (20.00%)
  2 (20.00%) high mild
...
Warning: Unable to complete 10 samples in 5.0s. You may wish to increase target time to 8.1s or enable flat sampling.
Benchmarking scaling/immutabledb_open/mmap_cached/50000: Collecting 10 samples in estimated 8.1304 s (55 iterations)
Benchmarking scaling/immutabledb_open/mmap_cached/50000: Analyzing
scaling/immutabledb_open/mmap_cached/50000
                        time:   [147.43 ms 147.68 ms 147.93 ms]
                        change: [−67.768% −67.631% −67.533%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking scaling/immutabledb_open/in_memory/100000: Collecting 10 samples in estimated 5.4082 s (10 iterations)
Benchmarking scaling/immutabledb_open/in_memory/100000: Analyzing
scaling/immutabledb_open/in_memory/100000
                        time:   [289.42 ms 290.74 ms 292.87 ms]
                        change: [−68.059% −67.902% −67.640%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
Benchmarking scaling/immutabledb_open/mmap_cached/100000: Collecting 10 samples in estimated 5.8115 s (20 iterations)
Benchmarking scaling/immutabledb_open/mmap_cached/100000: Analyzing
scaling/immutabledb_open/mmap_cached/100000
                        time:   [289.65 ms 291.94 ms 295.96 ms]
                        change: [−68.029% −67.779% −67.327%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 10 measurements (20.00%)
  1 (10.00%) high mild
  1 (10.00%) high severe
...
Benchmarking scaling/chaindb_insert/default_20kb/10000: Collecting 10 samples in estimated 5.3405 s (20 iterations)
Benchmarking scaling/chaindb_insert/default_20kb/10000: Analyzing
scaling/chaindb_insert/default_20kb/10000
                        time:   [264.74 ms 266.65 ms 268.35 ms]
                        change: [+3.3054% +4.4094% +5.6633%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_store/insert/default/1000000: Collecting 10 samples in estimated 26.307 s (10 iterations)
Benchmarking utxo_store/insert/default/1000000: Analyzing
utxo_store/insert/default/1000000
                        time:   [2.5741 s 2.5896 s 2.6025 s]
                        change: [−4.2667% −3.3021% −2.4127%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 10 measurements (20.00%)
  1 (10.00%) low severe
  1 (10.00%) low mild
...
Benchmarking utxo_store/lookup/hit/1000000: Collecting 100 samples in estimated 5.7121 s (10k iterations)
Benchmarking utxo_store/lookup/hit/1000000: Analyzing
utxo_store/lookup/hit/1000000
                        time:   [565.24 µs 565.75 µs 566.24 µs]
                        change: [+0.3395% +0.7500% +1.1917%] (p = 0.00 < 0.05)
                        Change within noise threshold.
Found 4 outliers among 100 measurements (4.00%)
  1 (1.00%) high mild
  3 (3.00%) high severe
...
Benchmarking utxo_store/lookup/miss/1000000: Collecting 100 samples in estimated 5.2072 s (15k iterations)
Benchmarking utxo_store/lookup/miss/1000000: Analyzing
utxo_store/lookup/miss/1000000
                        time:   [342.67 µs 343.02 µs 343.41 µs]
                        change: [+1.7036% +2.8603% +4.6887%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 10 outliers among 100 measurements (10.00%)
  5 (5.00%) high mild
  5 (5.00%) high severe
...
Benchmarking utxo_store/contains/hit: Collecting 100 samples in estimated 6.9155 s (15k iterations)
Benchmarking utxo_store/contains/hit: Analyzing
utxo_store/contains/hit time:   [454.63 µs 454.84 µs 455.08 µs]
                        change: [+1.1267% +1.4581% +1.7856%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_store/contains/miss: Collecting 100 samples in estimated 5.1548 s (15k iterations)
Benchmarking utxo_store/contains/miss: Analyzing
utxo_store/contains/miss
                        time:   [337.47 µs 338.41 µs 339.53 µs]
                        change: [+5.9150% +6.3747% +6.9289%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_store/remove/sequential/1000000: Collecting 10 samples in estimated 50.476 s (10 iterations)
Benchmarking utxo_store/remove/sequential/1000000: Analyzing
utxo_store/remove/sequential/1000000
                        time:   [2.6481 s 2.6626 s 2.6774 s]
                        change: [−3.8719% −3.2096% −2.5733%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Warning: Unable to complete 10 samples in 5.0s. You may wish to increase target time to 26.3s.
Benchmarking utxo_store/apply_tx/block_50tx_3in_2out: Collecting 10 samples in estimated 26.297 s (10 iterations)
Benchmarking utxo_store/apply_tx/block_50tx_3in_2out: Analyzing
utxo_store/apply_tx/block_50tx_3in_2out
                        time:   [292.06 ms 297.71 ms 303.34 ms]
                        change: [+1.6587% +6.4411% +12.038%] (p = 0.02 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_store/apply_tx/block_300tx_2in_2out: Collecting 10 samples in estimated 25.763 s (10 iterations)
Benchmarking utxo_store/apply_tx/block_300tx_2in_2out: Analyzing
utxo_store/apply_tx/block_300tx_2in_2out
                        time:   [276.32 ms 280.10 ms 284.28 ms]
                        change: [−2.7931% +0.5959% +3.7114%] (p = 0.75 > 0.05)
                        No change in performance detected.
...
Benchmarking utxo_store/multi_asset/insert_mixed_30pct/1000000: Collecting 10 samples in estimated 33.687 s (10 iterations)
...
utxo_store/multi_asset/insert_mixed_30pct/1000000
                        time:   [3.3531 s 3.3653 s 3.3784 s]
                        change: [−3.3342% −2.7652% −2.1799%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking utxo_store/multi_asset/lookup_mixed_30pct/1000000: Collecting 10 samples in estimated 33.982 s (10 iterations)
...
utxo_store/multi_asset/lookup_mixed_30pct/1000000
                        time:   [112.28 ms 117.38 ms 122.21 ms]
                        change: [−11.497% −3.7055% +5.7164%] (p = 0.45 > 0.05)
                        No change in performance detected.
...
Warning: Unable to complete 100 samples in 5.0s. You may wish to increase target time to 28.4s, or reduce sample count to 10.
Benchmarking utxo_store/total_lovelace/scan/1000000: Collecting 100 samples in estimated 28.399 s (100 iterations)
Benchmarking utxo_store/total_lovelace/scan/1000000: Analyzing
utxo_store/total_lovelace/scan/1000000
                        time:   [271.94 ms 272.80 ms 273.77 ms]
                        change: [−0.4892% −0.1212% +0.2623%] (p = 0.55 > 0.05)
                        No change in performance detected.
Found 9 outliers among 100 measurements (9.00%)
  8 (8.00%) high mild
  1 (1.00%) high severe
...
Benchmarking utxo_store/rebuild_address_index/rebuild/1000000: Collecting 10 samples in estimated 34.738 s (10 iterations)
Benchmarking utxo_store/rebuild_address_index/rebuild/1000000: Analyzing
utxo_store/rebuild_address_index/rebuild/1000000
                        time:   [472.30 ms 475.76 ms 480.18 ms]
                        change: [−1.7426% −0.8224% +0.1920%] (p = 0.14 > 0.05)
                        No change in performance detected.
Found 2 outliers among 10 measurements (20.00%)
  1 (10.00%) low mild
  1 (10.00%) high severe
...
Benchmarking utxo_store/insert_configs/low_8gb/1000000: Collecting 10 samples in estimated 25.684 s (10 iterations)
Benchmarking utxo_store/insert_configs/low_8gb/1000000: Analyzing
utxo_store/insert_configs/low_8gb/1000000
                        time:   [2.5750 s 2.5832 s 2.5918 s]
                        change: [−2.0354% −1.5240% −1.0193%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking utxo_store/insert_configs/mid_16gb/1000000: Collecting 10 samples in estimated 25.613 s (10 iterations)
Benchmarking utxo_store/insert_configs/mid_16gb/1000000: Analyzing
utxo_store/insert_configs/mid_16gb/1000000
                        time:   [2.5506 s 2.5619 s 2.5751 s]
                        change: [−3.4283% −2.8608% −2.2315%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 10 measurements (20.00%)
  2 (20.00%) high mild
...
Warning: Unable to complete 10 samples in 5.0s. You may wish to increase target time to 25.8s.
Benchmarking utxo_store/insert_configs/high_32gb/1000000: Collecting 10 samples in estimated 25.752 s (10 iterations)
Benchmarking utxo_store/insert_configs/high_32gb/1000000: Analyzing
utxo_store/insert_configs/high_32gb/1000000
                        time:   [2.5535 s 2.5616 s 2.5698 s]
                        change: [−3.0694% −2.5609% −2.1041%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Warning: Unable to complete 10 samples in 5.0s. You may wish to increase target time to 25.6s.
Benchmarking utxo_store/insert_configs/high_bloom_16gb/1000000: Collecting 10 samples in estimated 25.598 s (10 iterations)
...
utxo_store/insert_configs/high_bloom_16gb/1000000
                        time:   [2.5593 s 2.5685 s 2.5790 s]
                        change: [−3.1229% −2.6597% −2.1329%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Warning: Unable to complete 10 samples in 5.0s. You may wish to increase target time to 25.6s.
Benchmarking utxo_store/insert_configs/legacy_small/1000000: Collecting 10 samples in estimated 25.645 s (10 iterations)
Benchmarking utxo_store/insert_configs/legacy_small/1000000: Analyzing
utxo_store/insert_configs/legacy_small/1000000
                        time:   [2.5667 s 2.5722 s 2.5781 s]
                        change: [−2.8101% −2.5006% −2.1962%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking utxo_store/lookup_configs/low_8gb/1000000: Collecting 100 samples in estimated 6.6698 s (15k iterations)
Benchmarking utxo_store/lookup_configs/low_8gb/1000000: Analyzing
utxo_store/lookup_configs/low_8gb/1000000
                        time:   [440.81 µs 442.08 µs 443.54 µs]
                        change: [−0.7971% −0.2357% +0.4301%] (p = 0.46 > 0.05)
                        No change in performance detected.
...
Benchmarking utxo_store/lookup_configs/mid_16gb/1000000: Collecting 100 samples in estimated 6.5962 s (15k iterations)
Benchmarking utxo_store/lookup_configs/mid_16gb/1000000: Analyzing
utxo_store/lookup_configs/mid_16gb/1000000
                        time:   [436.23 µs 436.73 µs 437.29 µs]
                        change: [−0.7612% −0.5230% −0.2623%] (p = 0.00 < 0.05)
                        Change within noise threshold.
Found 4 outliers among 100 measurements (4.00%)
  1 (1.00%) high mild
  3 (3.00%) high severe
...
Benchmarking utxo_store/lookup_configs/high_32gb/1000000: Collecting 100 samples in estimated 6.5910 s (15k iterations)
Benchmarking utxo_store/lookup_configs/high_32gb/1000000: Analyzing
utxo_store/lookup_configs/high_32gb/1000000
                        time:   [433.44 µs 433.78 µs 434.20 µs]
                        change: [−2.4111% −1.9902% −1.5504%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 4 outliers among 100 measurements (4.00%)
  2 (2.00%) high mild
  2 (2.00%) high severe
...
Benchmarking utxo_store/lookup_configs/high_bloom_16gb/1000000: Collecting 100 samples in estimated 6.6989 s (15k iterations)
...
utxo_store/lookup_configs/high_bloom_16gb/1000000
                        time:   [442.88 µs 444.57 µs 447.29 µs]
                        change: [−0.1901% +0.2856% +0.7666%] (p = 0.26 > 0.05)
                        No change in performance detected.
Found 10 outliers among 100 measurements (10.00%)
  1 (1.00%) low severe
  5 (5.00%) low mild
...
Benchmarking utxo_store/lookup_configs/legacy_small/1000000: Collecting 100 samples in estimated 6.6528 s (15k iterations)
Benchmarking utxo_store/lookup_configs/legacy_small/1000000: Analyzing
utxo_store/lookup_configs/legacy_small/1000000
                        time:   [438.64 µs 439.06 µs 439.66 µs]
                        change: [−0.9114% −0.5624% −0.1639%] (p = 0.00 < 0.05)
                        Change within noise threshold.
Found 5 outliers among 100 measurements (5.00%)
  1 (1.00%) high mild
  4 (4.00%) high severe
...
Benchmarking utxo_scaling/insert/default/100000: Collecting 10 samples in estimated 6.2812 s (30 iterations)
Benchmarking utxo_scaling/insert/default/100000: Analyzing
utxo_scaling/insert/default/100000
                        time:   [209.16 ms 209.81 ms 210.57 ms]
                        change: [−4.1932% −3.6136% −2.9953%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
Benchmarking utxo_scaling/insert/default/500000: Collecting 10 samples in estimated 12.003 s (10 iterations)
Benchmarking utxo_scaling/insert/default/500000: Analyzing
utxo_scaling/insert/default/500000
                        time:   [1.2036 s 1.2091 s 1.2144 s]
                        change: [−3.6480% −2.3993% −1.1314%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking utxo_scaling/insert/default/1000000: Collecting 10 samples in estimated 25.521 s (10 iterations)
Benchmarking utxo_scaling/insert/default/1000000: Analyzing
utxo_scaling/insert/default/1000000
                        time:   [2.5753 s 2.5818 s 2.5899 s]
                        change: [−2.4488% −1.9550% −1.4355%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high mild
...
Benchmarking utxo_scaling/lookup/hit/100000: Collecting 10 samples in estimated 5.0048 s (14k iterations)
Benchmarking utxo_scaling/lookup/hit/100000: Analyzing
utxo_scaling/lookup/hit/100000
                        time:   [359.31 µs 359.57 µs 360.20 µs]
                        change: [−0.5618% −0.0272% +0.6871%] (p = 0.94 > 0.05)
                        No change in performance detected.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
utxo_scaling/lookup/hit/500000
                        time:   [408.81 µs 409.47 µs 410.78 µs]
                        change: [−0.6353% +0.0033% +0.5176%] (p = 0.99 > 0.05)
                        No change in performance detected.
Benchmarking utxo_scaling/lookup/hit/1000000
Benchmarking utxo_scaling/lookup/hit/1000000: Warming up for 3.0000 s
Benchmarking utxo_scaling/lookup/hit/1000000: Collecting 10 samples in estimated 5.0079 s (11k iterations)
Benchmarking utxo_scaling/lookup/hit/1000000: Analyzing
utxo_scaling/lookup/hit/1000000
                        time:   [445.90 µs 446.41 µs 447.65 µs]
                        change: [+2.0346% +2.3347% +2.6863%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) high severe
...
Benchmarking utxo_scaling/apply_tx/block_50tx_3in_2out/100000: Collecting 10 samples in estimated 6.3205 s (30 iterations)
Benchmarking utxo_scaling/apply_tx/block_50tx_3in_2out/100000: Analyzing
utxo_scaling/apply_tx/block_50tx_3in_2out/100000
                        time:   [12.735 ms 13.334 ms 14.010 ms]
                        change: [+2.3341% +8.3345% +14.936%] (p = 0.02 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_scaling/apply_tx/block_50tx_3in_2out/500000: Collecting 10 samples in estimated 12.094 s (10 iterations)
Benchmarking utxo_scaling/apply_tx/block_50tx_3in_2out/500000: Analyzing
utxo_scaling/apply_tx/block_50tx_3in_2out/500000
                        time:   [118.32 ms 124.15 ms 128.90 ms]
                        change: [−8.0422% −2.7553% +2.7352%] (p = 0.36 > 0.05)
                        No change in performance detected.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) low mild
...
Warning: Unable to complete 10 samples in 5.0s. You may wish to increase target time to 25.6s.
Benchmarking utxo_scaling/apply_tx/block_50tx_3in_2out/1000000: Collecting 10 samples in estimated 25.571 s (10 iterations)
...
utxo_scaling/apply_tx/block_50tx_3in_2out/1000000
                        time:   [264.82 ms 270.03 ms 274.92 ms]
                        change: [−3.6834% −0.6039% +2.8033%] (p = 0.73 > 0.05)
                        No change in performance detected.
...
Benchmarking utxo_scaling/total_lovelace/scan/100000: Collecting 10 samples in estimated 5.7124 s (220 iterations)
Benchmarking utxo_scaling/total_lovelace/scan/100000: Analyzing
utxo_scaling/total_lovelace/scan/100000
                        time:   [25.671 ms 26.043 ms 26.434 ms]
                        change: [+4.3794% +6.6316% +8.8948%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking utxo_scaling/total_lovelace/scan/500000: Collecting 10 samples in estimated 7.5293 s (55 iterations)
Benchmarking utxo_scaling/total_lovelace/scan/500000: Analyzing
utxo_scaling/total_lovelace/scan/500000
                        time:   [135.20 ms 135.47 ms 135.81 ms]
                        change: [−0.7882% −0.2517% +0.1035%] (p = 0.42 > 0.05)
                        No change in performance detected.
Found 2 outliers among 10 measurements (20.00%)
  1 (10.00%) low severe
  1 (10.00%) high mild
...
Benchmarking utxo_scaling/total_lovelace/scan/1000000: Collecting 10 samples in estimated 5.5920 s (20 iterations)
Benchmarking utxo_scaling/total_lovelace/scan/1000000: Analyzing
utxo_scaling/total_lovelace/scan/1000000
                        time:   [274.80 ms 276.00 ms 276.76 ms]
                        change: [+2.1977% +2.6709% +3.0402%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 4 outliers among 10 measurements (40.00%)
  2 (20.00%) low severe
  1 (10.00%) high mild
...
Benchmarking utxo_large_scale/insert/default/5000000: Collecting 10 samples in estimated 153.98 s (10 iterations)
Benchmarking utxo_large_scale/insert/default/5000000: Analyzing
utxo_large_scale/insert/default/5000000
                        time:   [15.329 s 15.368 s 15.408 s]
                        change: [−2.7061% −2.3607% −2.0200%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Warning: Unable to complete 10 samples in 5.0s. You may wish to increase target time to 336.4s.
Benchmarking utxo_large_scale/insert/default/10000000: Collecting 10 samples in estimated 336.44 s (10 iterations)
Benchmarking utxo_large_scale/insert/default/10000000: Analyzing
utxo_large_scale/insert/default/10000000
                        time:   [32.710 s 32.786 s 32.857 s]
                        change: [−2.7759% −2.4553% −2.1258%] (p = 0.00 < 0.05)
                        Performance has improved.

Benchmarking utxo_large_scale/lookup/hit/5000000
Benchmarking utxo_large_scale/lookup/hit/5000000: Warming up for 3.0000 s
Benchmarking utxo_large_scale/lookup/hit/5000000: Collecting 10 samples in estimated 5.0522 s (4070 iterations)
Benchmarking utxo_large_scale/lookup/hit/5000000: Analyzing
utxo_large_scale/lookup/hit/5000000
                        time:   [1.2331 ms 1.2337 ms 1.2346 ms]
                        change: [−4.9670% −4.8469% −4.7289%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 10 measurements (10.00%)
  1 (10.00%) low mild
...
Benchmarking utxo_large_scale/lookup/hit/10000000: Collecting 10 samples in estimated 5.0458 s (3245 iterations)
Benchmarking utxo_large_scale/lookup/hit/10000000: Analyzing
utxo_large_scale/lookup/hit/10000000
                        time:   [1.5290 ms 1.5298 ms 1.5310 ms]
                        change: [−2.4214% −2.3267% −2.2377%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking utxo_large_scale/total_lovelace/scan/5000000: Collecting 10 samples in estimated 15.506 s (10 iterations)
Benchmarking utxo_large_scale/total_lovelace/scan/5000000: Analyzing
utxo_large_scale/total_lovelace/scan/5000000
                        time:   [1.5489 s 1.5535 s 1.5593 s]
                        change: [+0.1971% +0.5410% +0.9273%] (p = 0.01 < 0.05)
                        Change within noise threshold.
Found 3 outliers among 10 measurements (30.00%)
  1 (10.00%) low severe
  1 (10.00%) high mild
...
Benchmarking utxo_large_scale/total_lovelace/scan/10000000: Collecting 10 samples in estimated 30.814 s (10 iterations)
Benchmarking utxo_large_scale/total_lovelace/scan/10000000: Analyzing
utxo_large_scale/total_lovelace/scan/10000000
                        time:   [3.0888 s 3.0951 s 3.1013 s]
                        change: [−1.5678% −0.6507% +0.1625%] (p = 0.20 > 0.05)
                        No change in performance detected.
...
Benchmarking ledger/apply_block/apply_only_shelley_50tx: Collecting 20 samples in estimated 5.0014 s (69k iterations)
Benchmarking ledger/apply_block/apply_only_shelley_50tx: Analyzing
ledger/apply_block/apply_only_shelley_50tx
                        time:   [69.278 µs 69.297 µs 69.315 µs]
                        change: [−2.9419% −2.4291% −2.0343%] (p = 0.00 < 0.05)
                        Performance has improved.
...
Benchmarking ledger/apply_block/validate_all_shelley_50tx: Collecting 20 samples in estimated 5.0084 s (38k iterations)
Benchmarking ledger/apply_block/validate_all_shelley_50tx: Analyzing
ledger/apply_block/validate_all_shelley_50tx
                        time:   [130.16 µs 130.29 µs 130.44 µs]
                        change: [−4.0846% −3.9167% −3.7614%] (p = 0.00 < 0.05)
                        Performance has improved.
...
network/handshake_encode/n2n_version_data
                        time:   [43.522 ns 43.589 ns 43.667 ns]
                        change: [+22.728% +23.263% +23.706%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 7 outliers among 100 measurements (7.00%)
  4 (4.00%) high mild
  3 (3.00%) high severe
...
network/handshake_encode/n2c_version_data
                        time:   [23.968 ns 24.051 ns 24.133 ns]
                        change: [+5.4368% +5.8678% +6.2768%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high mild
...
Benchmarking network/chainsync/roll_forward/encode/256: Collecting 100 samples in estimated 5.0002 s (42M iterations)
Benchmarking network/chainsync/roll_forward/encode/256: Analyzing
network/chainsync/roll_forward/encode/256
                        time:   [120.19 ns 120.43 ns 120.65 ns]
                        thrpt:  [2.4006 GiB/s 2.4050 GiB/s 2.4099 GiB/s]
                 change:
                        time:   [+33.090% +33.785% +34.835%] (p = 0.00 < 0.05)
                        thrpt:  [−25.835% −25.253% −24.863%]
                        Performance has regressed.
Found 3 outliers among 100 measurements (3.00%)
  1 (1.00%) high mild
  2 (2.00%) high severe
...
Benchmarking network/chainsync/roll_forward/decode/256: Collecting 100 samples in estimated 5.0005 s (50M iterations)
Benchmarking network/chainsync/roll_forward/decode/256: Analyzing
network/chainsync/roll_forward/decode/256
                        time:   [99.326 ns 99.453 ns 99.578 ns]
                        thrpt:  [2.9087 GiB/s 2.9123 GiB/s 2.9161 GiB/s]
                 change:
                        time:   [+8.1649% +8.5183% +8.9679%] (p = 0.00 < 0.05)
                        thrpt:  [−8.2298% −7.8496% −7.5485%]
                        Performance has regressed.
Found 8 outliers among 100 measurements (8.00%)
  6 (6.00%) low mild
  1 (1.00%) high mild
...
network/chainsync/roll_forward/encode/1024
                        time:   [166.87 ns 167.16 ns 167.41 ns]
                        thrpt:  [6.0026 GiB/s 6.0115 GiB/s 6.0221 GiB/s]
                 change:
                        time:   [+41.993% +42.386% +42.815%] (p = 0.00 < 0.05)
                        thrpt:  [−29.979% −29.768% −29.574%]
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
...
Benchmarking network/chainsync/roll_forward/decode/1024: Collecting 100 samples in estimated 5.0003 s (46M iterations)
Benchmarking network/chainsync/roll_forward/decode/1024: Analyzing
network/chainsync/roll_forward/decode/1024
                        time:   [106.40 ns 106.64 ns 106.90 ns]
                        thrpt:  [9.4001 GiB/s 9.4232 GiB/s 9.4448 GiB/s]
                 change:
                        time:   [+12.511% +12.923% +13.393%] (p = 0.00 < 0.05)
                        thrpt:  [−11.811% −11.444% −11.120%]
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
...
Benchmarking network/chainsync/roll_forward/encode/4096: Collecting 100 samples in estimated 5.0011 s (18M iterations)
Benchmarking network/chainsync/roll_forward/encode/4096: Analyzing
network/chainsync/roll_forward/encode/4096
                        time:   [279.13 ns 279.48 ns 279.83 ns]
                        thrpt:  [13.815 GiB/s 13.832 GiB/s 13.850 GiB/s]
                 change:
                        time:   [+84.346% +85.070% +85.617%] (p = 0.00 < 0.05)
                        thrpt:  [−46.126% −45.966% −45.754%]
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high mild
...
network/chainsync/roll_forward/decode/4096
                        time:   [193.41 ns 193.77 ns 194.18 ns]
                        thrpt:  [19.909 GiB/s 19.951 GiB/s 19.988 GiB/s]
                 change:
                        time:   [+30.574% +31.129% +31.585%] (p = 0.00 < 0.05)
                        thrpt:  [−24.004% −23.739% −23.415%]
                        Performance has regressed.
Found 5 outliers among 100 measurements (5.00%)
  4 (4.00%) high mild
  1 (1.00%) high severe
...
network/chainsync/roll_backward/encode
                        time:   [164.51 ns 164.71 ns 164.93 ns]
                        thrpt:  [508.85 MiB/s 509.52 MiB/s 510.15 MiB/s]
                 change:
                        time:   [+19.114% +19.601% +19.991%] (p = 0.00 < 0.05)
                        thrpt:  [−16.660% −16.389% −16.047%]
                        Performance has regressed.
Found 3 outliers among 100 measurements (3.00%)
  3 (3.00%) high severe
...
Benchmarking network/chainsync/roll_backward/decode: Collecting 100 samples in estimated 5.0001 s (69M iterations)
Benchmarking network/chainsync/roll_backward/decode: Analyzing
network/chainsync/roll_backward/decode
                        time:   [72.957 ns 73.441 ns 73.977 ns]
                        thrpt:  [1.1079 GiB/s 1.1160 GiB/s 1.1233 GiB/s]
                 change:
                        time:   [+31.879% +32.617% +33.341%] (p = 0.00 < 0.05)
                        thrpt:  [−25.004% −24.595% −24.173%]
                        Performance has regressed.
Found 5 outliers among 100 measurements (5.00%)
  4 (4.00%) high mild
  1 (1.00%) high severe
...
network/blockfetch/msg_block/encode/2048
                        time:   [110.29 ns 110.48 ns 110.69 ns]
                        thrpt:  [17.274 GiB/s 17.307 GiB/s 17.337 GiB/s]
                 change:
                        time:   [+23.351% +23.685% +24.202%] (p = 0.00 < 0.05)
                        thrpt:  [−19.486% −19.149% −18.930%]
                        Performance has regressed.
Found 8 outliers among 100 measurements (8.00%)
  5 (5.00%) high mild
  3 (3.00%) high severe
...
Benchmarking network/blockfetch/msg_block/decode/2048: Collecting 100 samples in estimated 5.0003 s (54M iterations)
Benchmarking network/blockfetch/msg_block/decode/2048: Analyzing
network/blockfetch/msg_block/decode/2048
                        time:   [89.566 ns 89.640 ns 89.740 ns]
                        thrpt:  [21.306 GiB/s 21.330 GiB/s 21.348 GiB/s]
                 change:
                        time:   [+9.5355% +9.7931% +10.052%] (p = 0.00 < 0.05)
                        thrpt:  [−9.1343% −8.9196% −8.7054%]
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
...
Benchmarking network/blockfetch/msg_block/encode/20480: Collecting 100 samples in estimated 5.0019 s (9.7M iterations)
Benchmarking network/blockfetch/msg_block/encode/20480: Analyzing
network/blockfetch/msg_block/encode/20480
                        time:   [510.66 ns 511.02 ns 511.47 ns]
                        thrpt:  [37.301 GiB/s 37.334 GiB/s 37.360 GiB/s]
                 change:
                        time:   [+7.8604% +8.0231% +8.2212%] (p = 0.00 < 0.05)
                        thrpt:  [−7.5967% −7.4272% −7.2876%]
                        Performance has regressed.
Found 8 outliers among 100 measurements (8.00%)
  2 (2.00%) high mild
  6 (6.00%) high severe
...
Benchmarking network/blockfetch/msg_block/decode/20480: Collecting 100 samples in estimated 5.0165 s (656k iterations)
Benchmarking network/blockfetch/msg_block/decode/20480: Analyzing
network/blockfetch/msg_block/decode/20480
                        time:   [7.6423 µs 7.6451 µs 7.6487 µs]
                        thrpt:  [2.4943 GiB/s 2.4955 GiB/s 2.4964 GiB/s]
                 change:
                        time:   [+28.132% +28.316% +28.547%] (p = 0.00 < 0.05)
                        thrpt:  [−22.208% −22.067% −21.956%]
                        Performance has regressed.
Found 7 outliers among 100 measurements (7.00%)
  4 (4.00%) high mild
  3 (3.00%) high severe
...
Benchmarking network/blockfetch/msg_block/encode/90000: Collecting 100 samples in estimated 5.0013 s (2.2M iterations)
Benchmarking network/blockfetch/msg_block/encode/90000: Analyzing
network/blockfetch/msg_block/encode/90000
                        time:   [2.2852 µs 2.2871 µs 2.2888 µs]
                        thrpt:  [36.624 GiB/s 36.652 GiB/s 36.683 GiB/s]
                 change:
                        time:   [+26.420% +26.738% +27.188%] (p = 0.00 < 0.05)
                        thrpt:  [−21.376% −21.097% −20.899%]
                        Performance has regressed.
Found 3 outliers among 100 measurements (3.00%)
  1 (1.00%) high mild
  2 (2.00%) high severe
...
network/blockfetch/msg_block/decode/90000
                        time:   [2.0485 µs 2.0495 µs 2.0506 µs]
                        thrpt:  [40.879 GiB/s 40.900 GiB/s 40.920 GiB/s]
                 change:
                        time:   [+14.341% +14.600% +14.995%] (p = 0.00 < 0.05)
                        thrpt:  [−13.040% −12.740% −12.543%]
                        Performance has regressed.
...
network/blockfetch/request_range/encode
                        time:   [105.44 ns 105.71 ns 106.12 ns]
                        change: [+18.062% +19.093% +20.041%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 10 outliers among 100 measurements (10.00%)
  1 (1.00%) low mild
  1 (1.00%) high mild
...
network/blockfetch/request_range/decode
                        time:   [70.396 ns 71.075 ns 71.753 ns]
                        change: [+37.421% +38.945% +40.732%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
...
network/n2c_query_encode/pparams/hfc_success
                        time:   [53.589 ns 53.608 ns 53.630 ns]
                        thrpt:  [1.5803 GiB/s 1.5809 GiB/s 1.5815 GiB/s]
                 change:
                        time:   [+26.656% +27.610% +28.327%] (p = 0.00 < 0.05)
                        thrpt:  [−22.074% −21.636% −21.046%]
                        Performance has regressed.
Found 7 outliers among 100 measurements (7.00%)
  2 (2.00%) high mild
  5 (5.00%) high severe
...
network/n2c_query_encode/pparams/tag24
                        time:   [54.177 ns 54.235 ns 54.291 ns]
                        thrpt:  [1.5610 GiB/s 1.5627 GiB/s 1.5643 GiB/s]
                 change:
                        time:   [+15.910% +16.100% +16.346%] (p = 0.00 < 0.05)
                        thrpt:  [−14.049% −13.867% −13.726%]
                        Performance has regressed.
...
network/n2c_query_encode/govstate/hfc_success
                        time:   [85.690 ns 85.757 ns 85.825 ns]
                        thrpt:  [8.4858 GiB/s 8.4926 GiB/s 8.4991 GiB/s]
                 change:
                        time:   [+32.565% +33.263% +34.008%] (p = 0.00 < 0.05)
                        thrpt:  [−25.378% −24.960% −24.565%]
                        Performance has regressed.
Found 7 outliers among 100 measurements (7.00%)
  1 (1.00%) low mild
  5 (5.00%) high mild
...
network/n2c_query_encode/govstate/tag24
                        time:   [91.729 ns 91.792 ns 91.864 ns]
                        thrpt:  [7.9280 GiB/s 7.9342 GiB/s 7.9397 GiB/s]
                 change:
                        time:   [+17.708% +18.065% +18.381%] (p = 0.00 < 0.05)
                        thrpt:  [−15.527% −15.301% −15.044%]
                        Performance has regressed.
Found 4 outliers among 100 measurements (4.00%)
  2 (2.00%) high mild
  2 (2.00%) high severe
...
network/n2c_query_encode/era_mismatch
                        time:   [24.181 ns 24.263 ns 24.349 ns]
                        thrpt:  [29.911 GiB/s 30.017 GiB/s 30.118 GiB/s]
                 change:
                        time:   [+8.2431% +8.6139% +8.9834%] (p = 0.00 < 0.05)
                        thrpt:  [−8.2429% −7.9308% −7.6153%]
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
...
Benchmarking consensus/vrf_leader_check/single/sigma=0.0000247: Collecting 100 samples in estimated 5.0956 s (162k iterations)
...
consensus/vrf_leader_check/single/sigma=0.0000247
                        time:   [31.570 µs 31.610 µs 31.662 µs]
                        change: [−19.155% −18.979% −18.798%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 16 outliers among 100 measurements (16.00%)
  2 (2.00%) low mild
  4 (4.00%) high mild
...
Benchmarking consensus/vrf_leader_check/single/sigma=0.001: Collecting 100 samples in estimated 5.1027 s (162k iterations)
Benchmarking consensus/vrf_leader_check/single/sigma=0.001: Analyzing
consensus/vrf_leader_check/single/sigma=0.001
                        time:   [31.569 µs 31.582 µs 31.597 µs]
                        change: [−19.911% −19.590% −19.377%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 4 outliers among 100 measurements (4.00%)
  1 (1.00%) high mild
  3 (3.00%) high severe
...
Benchmarking consensus/vrf_leader_check/single/sigma=0.01: Collecting 100 samples in estimated 5.1110 s (162k iterations)
Benchmarking consensus/vrf_leader_check/single/sigma=0.01: Analyzing
consensus/vrf_leader_check/single/sigma=0.01
                        time:   [31.556 µs 31.599 µs 31.653 µs]
                        change: [−21.714% −20.778% −20.048%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 7 outliers among 100 measurements (7.00%)
  1 (1.00%) high mild
  6 (6.00%) high severe
...
Benchmarking consensus/vrf_leader_check/batch/21600: Collecting 20 samples in estimated 13.657 s (20 iterations)
Benchmarking consensus/vrf_leader_check/batch/21600: Analyzing
consensus/vrf_leader_check/batch/21600
                        time:   [683.34 ms 683.60 ms 683.84 ms]
                        thrpt:  [31.586 Kelem/s 31.597 Kelem/s 31.610 Kelem/s]
                 change:
                        time:   [−19.776% −19.436% −19.192%] (p = 0.00 < 0.05)
                        thrpt:  [+23.750% +24.124% +24.651%]
                        Performance has improved.
Found 1 outliers among 20 measurements (5.00%)
  1 (5.00%) low mild
...
Benchmarking consensus/validate_header/replay_mode: Collecting 100 samples in estimated 5.0000 s (559M iterations)
Benchmarking consensus/validate_header/replay_mode: Analyzing
consensus/validate_header/replay_mode
                        time:   [8.9157 ns 8.9358 ns 8.9586 ns]
                        change: [−22.727% −22.465% −22.170%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 8 outliers among 100 measurements (8.00%)
  4 (4.00%) high mild
  4 (4.00%) high severe
...
consensus/chain_selection/longer_fork_100
                        time:   [1.3635 ns 1.3639 ns 1.3643 ns]
                        change: [−12.436% −12.314% −12.143%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 8 outliers among 100 measurements (8.00%)
  2 (2.00%) high mild
  6 (6.00%) high severe
...
Benchmarking consensus/chain_selection/equal_length_tiebreak: Collecting 100 samples in estimated 5.0000 s (19M iterations)
Benchmarking consensus/chain_selection/equal_length_tiebreak: Analyzing
consensus/chain_selection/equal_length_tiebreak
                        time:   [267.20 ns 267.78 ns 268.53 ns]
                        change: [−18.978% −18.734% −18.461%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 5 outliers among 100 measurements (5.00%)
  2 (2.00%) high mild
  3 (3.00%) high severe
...
consensus/chain_selection/prefer_simple
                        time:   [2.0520 ns 2.0560 ns 2.0600 ns]
                        change: [−15.367% −15.167% −14.973%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) low mild
...
Benchmarking lsm/insert/random_keys/10000: Collecting 10 samples in estimated 5.0689 s (1485 iterations)
Benchmarking lsm/insert/random_keys/10000: Analyzing
lsm/insert/random_keys/10000
                        time:   [3.2449 ms 3.2484 ms 3.2517 ms]
                        thrpt:  [3.0753 Melem/s 3.0784 Melem/s 3.0818 Melem/s]
                 change:
                        time:   [−1.6416% −1.3270% −1.0603%] (p = 0.00 < 0.05)
                        thrpt:  [+1.0717% +1.3449% +1.6690%]
                        Performance has improved.

Benchmarking lsm/point_lookup/hit_random/10000
Benchmarking lsm/point_lookup/hit_random/10000: Warming up for 3.0000 s
Benchmarking lsm/point_lookup/hit_random/10000: Collecting 100 samples in estimated 6.4062 s (15k iterations)
Benchmarking lsm/point_lookup/hit_random/10000: Analyzing
lsm/point_lookup/hit_random/10000
                        time:   [422.89 µs 424.90 µs 427.95 µs]
                        thrpt:  [2.3367 Melem/s 2.3535 Melem/s 2.3647 Melem/s]
                 change:
                        time:   [+1.9336% +3.0623% +4.3363%] (p = 0.00 < 0.05)
                        thrpt:  [−4.1560% −2.9713% −1.8969%]
                        Performance has regressed.
...
Benchmarking lsm/point_lookup/miss_random/10000: Collecting 100 samples in estimated 5.0035 s (50k iterations)
Benchmarking lsm/point_lookup/miss_random/10000: Analyzing
lsm/point_lookup/miss_random/10000
                        time:   [99.020 µs 99.108 µs 99.221 µs]
                        thrpt:  [10.078 Melem/s 10.090 Melem/s 10.099 Melem/s]
                 change:
                        time:   [+6.8015% +7.3926% +7.9688%] (p = 0.00 < 0.05)
                        thrpt:  [−7.3806% −6.8837% −6.3684%]
                        Performance has regressed.
Found 15 outliers among 100 measurements (15.00%)
  8 (8.00%) high mild
  7 (7.00%) high severe
...
Benchmarking lsm/range_scan/window_100_of_10k/10000: Collecting 20 samples in estimated 5.0020 s (86k iterations)
Benchmarking lsm/range_scan/window_100_of_10k/10000: Analyzing
lsm/range_scan/window_100_of_10k/10000
                        time:   [58.120 µs 58.171 µs 58.229 µs]
                        thrpt:  [1.7174 Melem/s 1.7191 Melem/s 1.7206 Melem/s]
                 change:
                        time:   [−6.0020% −5.7568% −5.5590%] (p = 0.00 < 0.05)
                        thrpt:  [+5.8862% +6.1085% +6.3852%]
                        Performance has improved.
Found 3 outliers among 20 measurements (15.00%)
  3 (15.00%) high mild
Benchmarking lsm/range_scan/full_scan/10000
Benchmarking lsm/range_scan/full_scan/10000: Warming up for 3.0000 s
Benchmarking lsm/range_scan/full_scan/10000: Collecting 20 samples in estimated 5.0439 s (3150 iterations)
Benchmarking lsm/range_scan/full_scan/10000: Analyzing
lsm/range_scan/full_scan/10000
                        time:   [1.6011 ms 1.6135 ms 1.6289 ms]
                        thrpt:  [6.1392 Melem/s 6.1976 Melem/s 6.2455 Melem/s]
                 change:
                        time:   [−3.7735% −3.3458% −2.9298%] (p = 0.00 < 0.05)
                        thrpt:  [+3.0182% +3.4616% +3.9215%]
                        Performance has improved.
...
Benchmarking lsm/apply_batch/inserts_10k_deletes_2.5k/10000: Collecting 10 samples in estimated 5.4084 s (440 iterations)
Benchmarking lsm/apply_batch/inserts_10k_deletes_2.5k/10000: Analyzing
lsm/apply_batch/inserts_10k_deletes_2.5k/10000
                        time:   [5.5049 ms 5.5633 ms 5.6150 ms]
                        thrpt:  [1.7810 Melem/s 1.7975 Melem/s 1.8166 Melem/s]
                 change:
                        time:   [+2.0403% +2.7004% +3.3629%] (p = 0.00 < 0.05)
                        thrpt:  [−3.2535% −2.6294% −1.9995%]
                        Performance has regressed.

Benchmarking lsm/snapshot/save_10k
Benchmarking lsm/snapshot/save_10k: Warming up for 3.0000 s
Benchmarking lsm/snapshot/save_10k: Collecting 10 samples in estimated 5.1971 s (715 iterations)
Benchmarking lsm/snapshot/save_10k: Analyzing
lsm/snapshot/save_10k   time:   [523.15 µs 531.06 µs 535.14 µs]
                        change: [−4.6717% −3.3086% −1.6196%] (p = 0.00 < 0.05)
                        Performance has improved.
Benchmarking lsm/snapshot/load_10k
Benchmarking lsm/snapshot/load_10k: Warming up for 3.0000 s
Benchmarking lsm/snapshot/load_10k: Collecting 10 samples in estimated 5.0976 s (605 iterations)
Benchmarking lsm/snapshot/load_10k: Analyzing
lsm/snapshot/load_10k   time:   [1.6353 ms 1.6400 ms 1.6471 ms]
                        change: [−4.9163% −4.3208% −3.4344%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 10 measurements (20.00%)
  1 (10.00%) low mild
  1 (10.00%) high severe
...
Benchmarking mempool/add/txs/1000: Collecting 100 samples in estimated 7.8015 s (10k iterations)
Benchmarking mempool/add/txs/1000: Analyzing
mempool/add/txs/1000    time:   [738.31 µs 739.21 µs 740.10 µs]
                        change: [+8.7195% +8.9448% +9.1947%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 4 outliers among 100 measurements (4.00%)
  2 (2.00%) high mild
  2 (2.00%) high severe
...
Benchmarking mempool/add/txs/5000: Collecting 100 samples in estimated 5.6176 s (600 iterations)
Benchmarking mempool/add/txs/5000: Analyzing
mempool/add/txs/5000    time:   [8.0533 ms 8.2992 ms 8.5388 ms]
                        change: [+27.637% +31.573% +35.629%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) low mild
Benchmarking mempool/add/txs/10000
Benchmarking mempool/add/txs/10000: Warming up for 3.0000 s
Benchmarking mempool/add/txs/10000: Collecting 100 samples in estimated 5.0865 s (300 iterations)
Benchmarking mempool/add/txs/10000: Analyzing
mempool/add/txs/10000   time:   [16.520 ms 17.305 ms 18.089 ms]
                        change: [+95.882% +105.91% +116.62%] (p = 0.00 < 0.05)
                        Performance has regressed.
...
Benchmarking mempool/remove/txs/1000: Collecting 100 samples in estimated 5.8031 s (5050 iterations)
Benchmarking mempool/remove/txs/1000: Analyzing
mempool/remove/txs/1000 time:   [473.97 µs 474.97 µs 475.95 µs]
                        change: [+26.946% +27.341% +27.747%] (p = 0.00 < 0.05)
                        Performance has regressed.
Benchmarking mempool/remove/txs/5000
Benchmarking mempool/remove/txs/5000: Warming up for 3.0000 s
Benchmarking mempool/remove/txs/5000: Collecting 100 samples in estimated 5.5274 s (900 iterations)
Benchmarking mempool/remove/txs/5000: Analyzing
mempool/remove/txs/5000 time:   [2.6586 ms 2.6636 ms 2.6686 ms]
                        change: [+19.518% +19.780% +20.060%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high mild
Benchmarking mempool/remove/txs/10000
Benchmarking mempool/remove/txs/10000: Warming up for 3.0000 s
Benchmarking mempool/remove/txs/10000: Collecting 100 samples in estimated 6.2807 s (400 iterations)
Benchmarking mempool/remove/txs/10000: Analyzing
mempool/remove/txs/10000
                        time:   [6.2845 ms 6.3668 ms 6.4544 ms]
                        change: [+28.416% +30.088% +31.962%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high mild
...
Benchmarking mempool/get_sorted/by_fee_density/1000: Collecting 100 samples in estimated 5.3566 s (71k iterations)
Benchmarking mempool/get_sorted/by_fee_density/1000: Analyzing
mempool/get_sorted/by_fee_density/1000
                        time:   [74.588 µs 74.785 µs 74.986 µs]
                        change: [+30.079% +30.725% +31.470%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 3 outliers among 100 measurements (3.00%)
  2 (2.00%) high mild
  1 (1.00%) high severe
...
Benchmarking mempool/get_sorted/by_fee_density/5000: Collecting 100 samples in estimated 5.4092 s (61k iterations)
Benchmarking mempool/get_sorted/by_fee_density/5000: Analyzing
mempool/get_sorted/by_fee_density/5000
                        time:   [89.917 µs 91.099 µs 92.665 µs]
                        change: [+57.871% +59.340% +61.229%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 3 outliers among 100 measurements (3.00%)
  1 (1.00%) high mild
  2 (2.00%) high severe
...
Benchmarking mempool/get_sorted/by_fee_density/10000: Collecting 100 samples in estimated 5.2636 s (71k iterations)
Benchmarking mempool/get_sorted/by_fee_density/10000: Analyzing
mempool/get_sorted/by_fee_density/10000
                        time:   [73.085 µs 73.245 µs 73.399 µs]
                        change: [+40.166% +40.973% +41.965%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high severe
...
Benchmarking mempool/drain_readd/txs/1000: Collecting 100 samples in estimated 7.3284 s (5050 iterations)
Benchmarking mempool/drain_readd/txs/1000: Analyzing
mempool/drain_readd/txs/1000
                        time:   [744.33 µs 747.08 µs 751.67 µs]
                        change: [+2.7071% +3.0783% +3.4830%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 5 outliers among 100 measurements (5.00%)
  2 (2.00%) high mild
  3 (3.00%) high severe
...
Benchmarking mempool/drain_readd/txs/5000: Collecting 100 samples in estimated 5.8050 s (700 iterations)
Benchmarking mempool/drain_readd/txs/5000: Analyzing
mempool/drain_readd/txs/5000
                        time:   [4.4015 ms 4.4305 ms 4.4619 ms]
                        change: [+11.086% +11.830% +12.624%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  3 (3.00%) high mild
  3 (3.00%) high severe
...
Benchmarking mempool/drain_readd/txs/10000: Collecting 100 samples in estimated 6.0657 s (200 iterations)
Benchmarking mempool/drain_readd/txs/10000: Analyzing
mempool/drain_readd/txs/10000
                        time:   [14.389 ms 14.489 ms 14.581 ms]
                        change: [+51.932% +53.218% +54.341%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 3 outliers among 100 measurements (3.00%)
  2 (2.00%) low severe
  1 (1.00%) low mild
...
Benchmarking mempool/batch_remove/50_from/5000: Collecting 100 samples in estimated 5.0015 s (3.4M iterations)
Benchmarking mempool/batch_remove/50_from/5000: Analyzing
mempool/batch_remove/50_from/5000
                        time:   [1.4840 µs 1.4847 µs 1.4857 µs]
                        change: [+33.861% +34.046% +34.268%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 8 outliers among 100 measurements (8.00%)
  3 (3.00%) low mild
  2 (2.00%) high mild
...
Benchmarking mempool/batch_remove/50_from/10000: Collecting 100 samples in estimated 5.0006 s (3.4M iterations)
Benchmarking mempool/batch_remove/50_from/10000: Analyzing
mempool/batch_remove/50_from/10000
                        time:   [1.4703 µs 1.4714 µs 1.4726 µs]
                        change: [+25.999% +27.392% +28.678%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  4 (4.00%) high mild
  2 (2.00%) high severe
...
Benchmarking ed25519_verify/single: Collecting 100 samples in estimated 5.0843 s (116k iterations)
Benchmarking ed25519_verify/single: Analyzing
ed25519_verify/single   time:   [43.941 µs 43.981 µs 44.017 µs]
                        change: [+38.853% +39.133% +39.445%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 7 outliers among 100 measurements (7.00%)
  3 (3.00%) low mild
  3 (3.00%) high mild
...
keyhash_from_vkey/single
                        time:   [173.92 ns 174.05 ns 174.19 ns]
                        change: [+50.585% +50.790% +50.995%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  4 (4.00%) low mild
  1 (1.00%) high mild
...
Benchmarking keyhash_from_vkey/batch/10: Collecting 100 samples in estimated 5.0053 s (2.9M iterations)
Benchmarking keyhash_from_vkey/batch/10: Analyzing
keyhash_from_vkey/batch/10
                        time:   [1.6396 µs 1.6414 µs 1.6431 µs]
                        change: [+38.448% +40.470% +42.506%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high mild
Benchmarking keyhash_from_vkey/batch/50
Benchmarking keyhash_from_vkey/batch/50: Warming up for 3.0000 s
Benchmarking keyhash_from_vkey/batch/50: Collecting 100 samples in estimated 5.0391 s (581k iterations)
Benchmarking keyhash_from_vkey/batch/50: Analyzing
keyhash_from_vkey/batch/50
                        time:   [8.1936 µs 8.1996 µs 8.2054 µs]
                        change: [+37.853% +39.956% +42.089%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
Benchmarking keyhash_from_vkey/batch/100
Benchmarking keyhash_from_vkey/batch/100: Warming up for 3.0000 s
Benchmarking keyhash_from_vkey/batch/100: Collecting 100 samples in estimated 5.0774 s (293k iterations)
Benchmarking keyhash_from_vkey/batch/100: Analyzing
keyhash_from_vkey/batch/100
                        time:   [16.400 µs 16.417 µs 16.434 µs]
                        change: [+48.976% +49.256% +49.485%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) high mild
  1 (1.00%) high severe
...
Benchmarking keyhash_from_vkey/batch/200: Collecting 100 samples in estimated 5.0729 s (146k iterations)
Benchmarking keyhash_from_vkey/batch/200: Analyzing
keyhash_from_vkey/batch/200
                        time:   [32.795 µs 32.827 µs 32.857 µs]
                        change: [+34.052% +35.957% +37.974%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) high mild
  1 (1.00%) high severe
...
Benchmarking keyhash_from_vkey/batch/500: Collecting 100 samples in estimated 5.2490 s (61k iterations)
Benchmarking keyhash_from_vkey/batch/500: Analyzing
keyhash_from_vkey/batch/500
                        time:   [82.042 µs 82.162 µs 82.281 µs]
                        change: [+37.556% +39.622% +41.739%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 4 outliers among 100 measurements (4.00%)
  2 (2.00%) high mild
  2 (2.00%) high severe
...
Benchmarking vrf_verify/single_proof: Collecting 100 samples in estimated 5.1423 s (30k iterations)
Benchmarking vrf_verify/single_proof: Analyzing
vrf_verify/single_proof time:   [168.35 µs 168.40 µs 168.45 µs]
                        change: [+85.836% +86.188% +86.722%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 6 outliers among 100 measurements (6.00%)
  4 (4.00%) high mild
  2 (2.00%) high severe
...
Benchmarking blake2b_256/hash/32B_txhash: Collecting 100 samples in estimated 5.0006 s (40M iterations)
Benchmarking blake2b_256/hash/32B_txhash: Analyzing
blake2b_256/hash/32B_txhash
                        time:   [125.38 ns 125.52 ns 125.66 ns]
                        change: [−21.412% −21.177% −20.938%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 4 outliers among 100 measurements (4.00%)
  3 (3.00%) high mild
  1 (1.00%) high severe
...
Benchmarking blake2b_256/hash/64B_vkey: Collecting 100 samples in estimated 5.0004 s (38M iterations)
Benchmarking blake2b_256/hash/64B_vkey: Analyzing
blake2b_256/hash/64B_vkey
                        time:   [133.04 ns 133.20 ns 133.38 ns]
                        change: [−16.369% −16.011% −15.677%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 100 measurements (2.00%)
  2 (2.00%) high severe
Benchmarking blake2b_256/hash/256B_small_tx
Benchmarking blake2b_256/hash/256B_small_tx: Warming up for 3.0000 s
Benchmarking blake2b_256/hash/256B_small_tx: Collecting 100 samples in estimated 5.0004 s (21M iterations)
Benchmarking blake2b_256/hash/256B_small_tx: Analyzing
blake2b_256/hash/256B_small_tx
                        time:   [233.65 ns 233.87 ns 234.08 ns]
                        change: [−15.957% −15.798% −15.631%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) high mild
  1 (1.00%) high severe
...
Benchmarking blake2b_256/hash/500B_avg_tx: Collecting 100 samples in estimated 5.0009 s (11M iterations)
Benchmarking blake2b_256/hash/500B_avg_tx: Analyzing
blake2b_256/hash/500B_avg_tx
                        time:   [466.89 ns 467.44 ns 468.09 ns]
                        change: [−13.031% −12.874% −12.704%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 6 outliers among 100 measurements (6.00%)
  1 (1.00%) high mild
  5 (5.00%) high severe
...
Benchmarking blake2b_256/hash/1KB_tx_body: Collecting 100 samples in estimated 5.0033 s (5.6M iterations)
Benchmarking blake2b_256/hash/1KB_tx_body: Analyzing
blake2b_256/hash/1KB_tx_body
                        time:   [895.03 ns 896.01 ns 897.10 ns]
                        change: [−14.740% −14.649% −14.554%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 2 outliers among 100 measurements (2.00%)
  1 (1.00%) high mild
  1 (1.00%) high severe
...
Benchmarking blake2b_256/hash/4KB_large_tx: Collecting 100 samples in estimated 5.0102 s (1.4M iterations)
Benchmarking blake2b_256/hash/4KB_large_tx: Analyzing
blake2b_256/hash/4KB_large_tx
                        time:   [3.5369 µs 3.5397 µs 3.5423 µs]
                        change: [−14.206% −14.097% −13.966%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
Benchmarking blake2b_256/hash/16KB_block_header
Benchmarking blake2b_256/hash/16KB_block_header: Warming up for 3.0000 s
Benchmarking blake2b_256/hash/16KB_block_header: Collecting 100 samples in estimated 5.0398 s (359k iterations)
Benchmarking blake2b_256/hash/16KB_block_header: Analyzing
blake2b_256/hash/16KB_block_header
                        time:   [14.104 µs 14.160 µs 14.242 µs]
                        change: [−13.999% −13.499% −12.731%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 9 outliers among 100 measurements (9.00%)
  3 (3.00%) high mild
  6 (6.00%) high severe
...
Benchmarking blake2b_256/hash/20KB_avg_block: Collecting 100 samples in estimated 5.0618 s (288k iterations)
Benchmarking blake2b_256/hash/20KB_avg_block: Analyzing
blake2b_256/hash/20KB_avg_block
                        time:   [17.623 µs 17.723 µs 17.876 µs]
                        change: [−14.184% −13.842% −13.440%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 5 outliers among 100 measurements (5.00%)
  1 (1.00%) high mild
  4 (4.00%) high severe
...
Benchmarking blake2b_256/hash/90KB_max_block: Collecting 100 samples in estimated 5.1987 s (66k iterations)
Benchmarking blake2b_256/hash/90KB_max_block: Analyzing
blake2b_256/hash/90KB_max_block
                        time:   [79.294 µs 79.427 µs 79.581 µs]
                        change: [−14.081% −13.997% −13.888%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 6 outliers among 100 measurements (6.00%)
  3 (3.00%) high mild
  3 (3.00%) high severe
...
Benchmarking blake2b_224/hash/32B_vkey_to_keyhash: Collecting 100 samples in estimated 5.0004 s (38M iterations)
Benchmarking blake2b_224/hash/32B_vkey_to_keyhash: Analyzing
blake2b_224/hash/32B_vkey_to_keyhash
                        time:   [133.54 ns 133.66 ns 133.78 ns]
                        change: [−20.612% −20.385% −20.153%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
Benchmarking blake2b_224/hash/64B_script_bytes
Benchmarking blake2b_224/hash/64B_script_bytes: Warming up for 3.0000 s
Benchmarking blake2b_224/hash/64B_script_bytes: Collecting 100 samples in estimated 5.0001 s (35M iterations)
Benchmarking blake2b_224/hash/64B_script_bytes: Analyzing
blake2b_224/hash/64B_script_bytes
                        time:   [142.18 ns 142.37 ns 142.57 ns]
                        change: [−14.215% −14.029% −13.815%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 4 outliers among 100 measurements (4.00%)
  4 (4.00%) high severe
...
Benchmarking blake2b_224/hash/256B_address_payload: Collecting 100 samples in estimated 5.0006 s (21M iterations)
Benchmarking blake2b_224/hash/256B_address_payload: Analyzing
blake2b_224/hash/256B_address_payload
                        time:   [241.89 ns 242.08 ns 242.26 ns]
                        change: [−15.304% −15.190% −15.087%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
...
Benchmarking blake2b_batch/224_keyhashes/10: Collecting 100 samples in estimated 5.0011 s (3.9M iterations)
Benchmarking blake2b_batch/224_keyhashes/10: Analyzing
blake2b_batch/224_keyhashes/10
                        time:   [1.2731 µs 1.2763 µs 1.2798 µs]
                        change: [−18.953% −18.753% −18.523%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 4 outliers among 100 measurements (4.00%)
  4 (4.00%) high mild
Benchmarking blake2b_batch/224_keyhashes/50
Benchmarking blake2b_batch/224_keyhashes/50: Warming up for 3.0000 s
Benchmarking blake2b_batch/224_keyhashes/50: Collecting 100 samples in estimated 5.0138 s (788k iterations)
Benchmarking blake2b_batch/224_keyhashes/50: Analyzing
blake2b_batch/224_keyhashes/50
                        time:   [6.3504 µs 6.3612 µs 6.3729 µs]
                        change: [−19.074% −18.910% −18.748%] (p = 0.00 < 0.05)
                        Performance has improved.
Benchmarking blake2b_batch/224_keyhashes/100
Benchmarking blake2b_batch/224_keyhashes/100: Warming up for 3.0000 s
Benchmarking blake2b_batch/224_keyhashes/100: Collecting 100 samples in estimated 5.0201 s (394k iterations)
Benchmarking blake2b_batch/224_keyhashes/100: Analyzing
blake2b_batch/224_keyhashes/100
                        time:   [12.724 µs 12.809 µs 12.926 µs]
                        change: [−18.888% −18.586% −18.190%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 3 outliers among 100 measurements (3.00%)
  1 (1.00%) high mild
  2 (2.00%) high severe
...
Benchmarking blake2b_batch/224_keyhashes/500: Collecting 100 samples in estimated 5.1503 s (81k iterations)
Benchmarking blake2b_batch/224_keyhashes/500: Analyzing
blake2b_batch/224_keyhashes/500
                        time:   [63.488 µs 63.599 µs 63.719 µs]
                        change: [−19.236% −19.053% −18.864%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
Benchmarking blake2b_batch/256_txbodies_500B/50
Benchmarking blake2b_batch/256_txbodies_500B/50: Warming up for 3.0000 s
Benchmarking blake2b_batch/256_txbodies_500B/50: Collecting 100 samples in estimated 5.0570 s (217k iterations)
Benchmarking blake2b_batch/256_txbodies_500B/50: Analyzing
blake2b_batch/256_txbodies_500B/50
                        time:   [23.218 µs 23.240 µs 23.263 µs]
                        change: [−12.879% −12.788% −12.697%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high severe
Benchmarking blake2b_batch/256_txbodies_500B/100
Benchmarking blake2b_batch/256_txbodies_500B/100: Warming up for 3.0000 s
Benchmarking blake2b_batch/256_txbodies_500B/100: Collecting 100 samples in estimated 5.1845 s (111k iterations)
Benchmarking blake2b_batch/256_txbodies_500B/100: Analyzing
blake2b_batch/256_txbodies_500B/100
                        time:   [46.457 µs 46.527 µs 46.633 µs]
                        change: [−12.853% −12.756% −12.651%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 3 outliers among 100 measurements (3.00%)
  1 (1.00%) high mild
  2 (2.00%) high severe
...
Benchmarking blake2b_batch/256_txbodies_500B/300: Collecting 100 samples in estimated 5.6792 s (40k iterations)
Benchmarking blake2b_batch/256_txbodies_500B/300: Analyzing
blake2b_batch/256_txbodies_500B/300
                        time:   [139.57 µs 140.44 µs 141.93 µs]
                        change: [−12.740% −12.363% −11.878%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 8 outliers among 100 measurements (8.00%)
  2 (2.00%) high mild
  6 (6.00%) high severe
...
Benchmarking serialization/encode_transaction/conway_2in_2out_2wit: Collecting 100 samples in estimated 5.0001 s (2.3M iterations)
...
serialization/encode_transaction/conway_2in_2out_2wit
                        time:   [2.1717 µs 2.1817 µs 2.1926 µs]
                        change: [+29.297% +29.956% +30.564%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 19 outliers among 100 measurements (19.00%)
  13 (13.00%) low mild
  1 (1.00%) high mild
...
Benchmarking serialization/encode_transaction/body_only_2in_2out: Collecting 100 samples in estimated 5.0060 s (3.6M iterations)
...
serialization/encode_transaction/body_only_2in_2out
                        time:   [1.4072 µs 1.4088 µs 1.4107 µs]
                        change: [+2.2236% +2.8406% +3.3482%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 13 outliers among 100 measurements (13.00%)
  4 (4.00%) low mild
  3 (3.00%) high mild
...
Benchmarking serialization/encode_block_header/with_vrf_output: Collecting 100 samples in estimated 5.0041 s (4.2M iterations)
...
serialization/encode_block_header/with_vrf_output
                        time:   [1.1678 µs 1.1700 µs 1.1731 µs]
                        change: [−5.7921% −5.3114% −4.8544%] (p = 0.00 < 0.05)
                        Performance has improved.
Found 6 outliers among 100 measurements (6.00%)
  1 (1.00%) high mild
  5 (5.00%) high severe
...
Benchmarking serialization/encode_value/ada_only: Collecting 100 samples in estimated 5.0000 s (173M iterations)
Benchmarking serialization/encode_value/ada_only: Analyzing
serialization/encode_value/ada_only
                        time:   [28.783 ns 28.832 ns 28.880 ns]
                        change: [+28.145% +28.500% +28.796%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) low mild
...
Benchmarking serialization/encode_value/multi_asset_3policy_5asset: Collecting 100 samples in estimated 5.0037 s (5.9M iterations)
...
serialization/encode_value/multi_asset_3policy_5asset
                        time:   [862.32 ns 863.75 ns 864.97 ns]
                        change: [+10.626% +10.961% +11.394%] (p = 0.00 < 0.05)
                        Performance has regressed.
Found 8 outliers among 100 measurements (8.00%)
  5 (5.00%) low mild
  1 (1.00%) high mild
