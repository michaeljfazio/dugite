#!/usr/bin/env bash
# 03b — Plutus V2 spend with datum hash. V2 added reference scripts/inputs
# and inline datums; this script keeps the hash form. See 03g for inline.
set -euo pipefail
...
DATUM="$ZOO_BUILT/always-true-v2.datum.json"
