...
NAME="$(zoo_name)"
zoo_require_devnet
# Minting has no datum — see the note in 03d and lib/build-plutus.sh.
SCRIPT="$ZOO_DIR/lib/plutus/always-true-v2-mint.plutus"
...
ASSET_NAME_HEX="$(printf 'TXZOOPV2' | xxd -p | tr -d '\n')"
QUANTITY=44
