#!/usr/bin/env bash
# 03d — Plutus V1 mint policy. Always-true validator is used as a minting
# script; any quantity is mintable with any redeemer.
set -euo pipefail
...
ASSET_NAME_HEX="$(printf 'TXZOOPV1' | xxd -p | tr -d '\n')"
QUANTITY=33
