...
impl EraRules for ConwayRules {
    ...
    fn apply_valid_tx(
        ...
        //
        // This check was temporarily disabled in commit 9a631979e due to a
        // 3505-lovelace reward balance discrepancy caused by the #438 bug
        // (undistributed pool rewards not routed to treasury, inflating reserves
        // and overstating pool rewards). Fixed in this commit — re-enabled.
        if ctx.params.protocol_version_major >= 10 {
