...
## In-progress
- item: #31-E pre-Conway body unknown-key reject FIXING DONE (Shelley+Babbage static `_=>Err`; Alonzo era-param guard gating keys 11/13/14/15 to Era::Alonzo so Allegra/Mary reject them; key 6 preserved; era_allegra/mary changes doc-only; fmt+clippy+nextest 1226/1226 INDEPENDENTLY verified; over-rejection guard verified). NEXT: GAUNTLET #31-E (fix UNCOMMITTED). [#0/#1 resolved per frontier; common.rs = ep246 scratch loose-end.]
