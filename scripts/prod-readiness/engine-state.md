...
## In-progress
- item: #0 (mainnet ep246 reserves) state:DIAGNOSING-DATA (frozen fvAddrsRew MISSING-credential hunt; data-diagnose waum3utic ACTIVE, polled wake247 15:13 — both agents querying Koios pool_history/account_reward_history).
