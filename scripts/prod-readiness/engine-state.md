...
## In-progress
- item: #31-D dup-MAP-key reject DONE — GAUNTLET w0fm1zn3f PASSED 0/3 (GOLD-STANDARD, raw-source-confirmed cd8b7fab: un-gated SparseKeyed applyField/decodeSparseKeyed dup-field-key reject); COMMITTED d42866c20b (1 crate dugite-serialization). for_each_field_entry strict at the 3 SparseKeyed sites; metadata+IntMap lenient. NEXT: SCHEDULE #31-E (pre-Conway body unknown-key reject, Shelley+). Also open: #28b (encoder chunk >64B leaves), #29-order[L], #26b, #24, + 2 NEW gauntlet-surfaced follow-ups #31-F/#31-G (below). [#0/#1 resolved per frontier.]
