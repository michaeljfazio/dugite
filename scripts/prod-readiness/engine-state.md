...
## In-progress
- item: #31-E pre-Conway body unknown-key reject ROOT-CAUSED (conf 0.9; diagnose wf5elt36l, raw-source-pinned cd8b7fab). NEXT: FIXING #31-E (Shelley+Babbage static `_=>Err`; Alonzo fn era-param guard for keys 11/13/14/15). [#0/#1 resolved per frontier; common.rs = ep246 scratch loose-end.]
