...
## In-progress
- item: #28b PlutusData encoder chunk-64 FIXING DONE (encode_bounded_plutus_bytes REUSING the #28 decoder const; applied to 2 plutus-leaf sites cbor.rs:336 Bytes + :143 bignum magnitude; generic encode_bytes UNTOUCHED; round-trip closure incl. bignum; fmt+clippy+nextest 1232/1232 INDEPENDENTLY verified). NEXT: GAUNTLET #28b (fix UNCOMMITTED; INERT → Tier B defensive). [#0/#1 resolved per frontier; common.rs = ep246 scratch loose-end.]
