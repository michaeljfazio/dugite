...
## In-progress
- item: #31-C Conway PV9+ set-dedup DONE — re-GAUNTLET w24gwy23h PASSED 0/3 (GOLD-STANDARD, raw-source-reconfirmed cd8b7fab); COMMITTED cf1bcf112b (1 crate dugite-serialization). 13 strict tag-258 sets reject dups (byte-exact Haskell decodeSet@9/OSet-all-version/scriptDecoderV9@9 at live PV11), 5 @12/list fields stay lenient. NEXT: SCHEDULE #31-D (dup-MAP-key reject in for_each_map_entry). #31-E (pre-Conway body unknown-key), #28b (encoder chunk >64B leaves), #29-order[L], #26b, #24 also remain.
