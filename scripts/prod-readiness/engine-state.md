...
## In-progress
- item: #32 consByteString variant DONE — GAUNTLET wsvwvp16v PASSED 0/3 (GOLD-STANDARD, raw-source-confirmed plutus d3c8d752/bddbf4b1); COMMITTED 257658b360 (1 crate dugite-uplc, incl NEW builtin/semantics.rs). consByteString lenient mod-256 for V1/V2 (strict ⟺ V3); VERIFYING phase2_repro 215→0, 502→717 MATCH no-regression, conformance 999/999. *** the 215-dump LIVE Babbage-PV8 phase-2 consensus divergence is CLOSED. NEXT: SCHEDULE the next open item — #24 [M] (PlutusV2 inline-datum-SPEND over-cost, ~51 budget-exhausted dumps remain = the dominant remaining phase-2 divergence) → re-DIAGNOSE/pin; then the [L] cluster (#33 WriteBits, #29-order, #26b, #31-F/G/H, #28b-cli). [#0/#1 resolved per frontier; common.rs = ep246 scratch loose-end.]
