...
## In-progress
- item: #32 consByteString variant FIXING+VERIFYING DONE (SemanticsVariant threaded; consByteString lenient rem_euclid-256 for V1/V2, strict V3; replicateByte/cost untouched; conformance 999/999 + nextest 1463/1463 INDEPENDENTLY verified). *** VERIFYING BYTE-EXACT PROOF: phase2_repro over 769 dumps post-fix = 717 MATCH / 52 DIVERGE (was 502/267); consByteString divergences 215→0; the 502 prior-passing UNCHANGED (now 717 = 502+215). Remaining 52 = 51 #24-budget + 1 wrong-accept. NEXT: GAUNTLET #32 (fix UNCOMMITTED; NEW file crates/dugite-uplc/src/builtin/semantics.rs must be git-added at commit). [#0/#1 resolved per frontier; common.rs = ep246 scratch loose-end.]
