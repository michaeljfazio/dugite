...
## In-progress
- item: #31-D dup-MAP-key reject FIXING DONE (for_each_field_entry applied to the 3 un-gated SparseKeyed sites [alonzo:1388 tag-259, conway:1050 TxOut, conway:2186 witness-set]; metadata + @9-IntMap kept lenient; fmt+clippy+nextest 1210/1210 INDEPENDENTLY verified; over-strictness guard verified; plutus_v1/v2/v3 @9-CONFIRMED = NO #31-C residual). NEXT: GAUNTLET #31-D (fix UNCOMMITTED). [#0/#1 resolved per frontier; common.rs = ep246 scratch loose-end.]
