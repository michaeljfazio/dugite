...
## In-progress
- item: #31-E pre-Conway body unknown-key reject DONE — GAUNTLET wbqi2tmmh PASSED 0/3 (GOLD-STANDARD, raw-source-confirmed cd8b7fab); COMMITTED 9dd7ed862f (1 crate dugite-serialization). Shelley+Babbage static reject; Alonzo era-guard (Allegra/Mary tightened to {0-9}); era-threading verified ALL call sites. *** #31 (A/B/C/D/E) FULLY DONE. NEXT: SCHEDULE #28b (encoder must chunk >64B PlutusData leaves — encoder side of the closed #28). #29-order[L], #26b, #24, #31-F/G/H also open. [#0/#1 resolved per frontier; common.rs = ep246 scratch loose-end.]
